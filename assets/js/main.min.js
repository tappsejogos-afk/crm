...
"1" == app.options.enable_google_picker && ($.fn.googleDrivePicker.defaults.clientId = app.options.google_client_id,
...
function _init_tasks_billable_select(e, t) {
    ...
    if (a.length > 0) {
        ...
        $.each(e, (function(e, t) {
            i = " ",
            !0 === t.started_timers ? i += 'disabled class="text-danger" data-subtext="' + app.lang.invoice_task_billable_timers_found + '"' : !1 === t.started_timers && "project" != t.rel_type && (i += 'data-subtext="' + t.rel_name + '"'),
            a.append('<option value="' + t.id + '"' + i + ">" + t.name + "</option>")
        }
        ));
        var n = $(".input-group-addon-bill-tasks-help");
        n.find(".popover-invoker").popover("destroy"),
        n.empty();
        var s = "";
        ...
        n.html('<span class="pointer popover-invoker" data-container=".form-group-select-task_select" data-trigger="click" data-placement="top" data-toggle="popover" data-content="' + s + '"><i class="fa-regular fa-circle-question"></i></span>'),
        delay((function() {
            (n.attr("info-shown-count") < 3 || void 0 === n.attr("info-shown-count")) && $(".projects-wrapper").is(":visible") && e.length > 0 && (n.attr("info-shown-count", void 0 === n.attr("info-shown-count") ? 1 : parseInt(n.attr("info-shown-count")) + 1),
            n.find(".popover-invoker").click())
        }
        ), 3500)
    }
...
function mainWrapperHeightFix() {
    ...
    setup_menu.css("min-height", $(document).outerHeight(!0) - 114 + "px"),
    $("#menu").css("min-height", $(document).outerHeight(!0) + "px"),
    content_wrapper.css("min-height", $(document).outerHeight(!0) - 57 + "px"),
    content_wrapper.css("height", "100%"),
    t < e && content_wrapper.css("min-height", e + "px"),
    t < e && e < $(window).height() && content_wrapper.css("min-height", $(window).height() - 57 + "px"),
    t > e && t < $(window).height() && content_wrapper.css("min-height", $(window).height() - 57 + "px"),
    is_mobile() && "true" == isRTL && side_bar.css("min-height", $(document).outerHeight(!0) - 57 + "px")
}
function set_body_small() {
    var e = null != navigator.userAgent.match(/iPad/i);
    $(this).width() < 769 || e || is_mobile() ? $("body").addClass("page-small") : $("body").removeClass("page-small show-sidebar")
}
function switch_field(e) {
    var t;
    t = 0,
    !0 === $(e).prop("checked") && (t = 1),
    requestGet($(e).data("switch-url") + "/" + $(e).data("id") + "/" + t)
}
...
function init_rel_tasks_table(e, t, a) {
    ...
    if (0 !== i.length) {
        ...
        s.tasks_related_to = '[name="tasks_related_to"]';
        var l = admin_url + "tasks/init_relation_tasks/" + e + "/" + t;
        "project" == i.attr("data-new-rel-type") && (l += "?bulk_actions=true"),
        initDataTable(i, l, o, o, s, [i.find("th.duedate").index(), "asc"])
    }
}
...
function initDataTable(e, t, a, i, n, s) {
    ...
    void 0 === s ? s = [[0, "asc"]] : 1 === s.length && (s = [s]);
    ...
    -1 == $.inArray(app.options.tables_pagination_limit, p) && (p.push(app.options.tables_pagination_limit),
    _.push(app.options.tables_pagination_limit)),
    p.sort((function(e, t) {
        return e - t
    }
    )),
    ...
    var m = {
        ...
        fnDrawCallback: function(e) {
            ...
            0 === e.aoData.length ? $(e.nTableWrapper).addClass("app_dt_empty") : $(e.nTableWrapper).removeClass("app_dt_empty")
        },
        fnCreatedRow: function(e, t, a) {
            $(e).attr("data-title", t.Data_Title),
            $(e).attr("data-toggle", t.Data_Toggle)
        },
        initComplete: function(e, t) {
            var a = this
              , i = $(".btn-dt-reload");
            i.attr("data-toggle", "tooltip"),
            i.attr("title", app.lang.dt_button_reload);
            var n = $(".dt-column-visibility");
            n.attr("data-toggle", "tooltip"),
            n.attr("title", app.lang.dt_button_column_visibility),
            a.wrap('<div class="table-responsive"></div>');
            var s = a.find(".dataTables_empty");
            s.length && s.attr("colspan", a.find("thead th").length),
            is_mobile() && $(window).width() < 400 && a.find('tbody td:first-child input[type="checkbox"]').length > 0 && (a.DataTable().column(0).visible(!1, !1).columns.adjust(),
            ...
            o.text().trim() == app.lang.options && o.addClass("not-export"),
            l.find('input[type="checkbox"]').length > 0 && l.addClass("not-export"),
        ...
        ajax: {
            ...
            type: "POST",
            data: function(e) {
                for (var t in Array.isArray(e.order) && (e.order = e.order.map((function(e) {
                    var t = o.find("thead th:eq(" + e.column + ")");
                    return t.length > 0 && 1 == t[0].dataset.customField && (e.type = t[0].dataset.type),
                    e
                }
                ))),
                ...
                var a = o[0].getAttribute("id");
                a && Object.hasOwn(app.dtFilters, a) && (e.filters = app.dtFilters[a])
            }
        },
    ...
    setTimeout((function() {
        for (var e in h)
            u.columns(h[e]).visible(!1, !1).columns.adjust()
    }
    ), 10),
    ...
    return o.is(":hidden") && o.find(".dataTables_empty").attr("colspan", o.find("thead th").length),
...
function task_attachments_toggle() {
    var e = $("#task-modal");
    e.find(".task_attachments_wrapper .task-attachments-more").toggleClass("hide"),
    e.find(".task_attachments_wrapper .task-attachments-less").toggleClass("hide")
}
function update_todo_items() {
    var e = $(".unfinished-todos li:not(.no-todos)")
      ...
      , a = 1;
    $.each(e, (function() {
        $(this).find('input[name="todo_order"]').val(a),
        $(this).find('input[name="finished"]').val(0),
        a++
    }
    )),
    0 === e.length ? ($(".nav-total-todos").addClass("hide"),
    $(".unfinished-todos li.no-todos").removeClass("hide")) : e.length > 0 && ($(".unfinished-todos li.no-todos").hasClass("hide") || $(".unfinished-todos li.no-todos").addClass("hide"),
    $(".nav-total-todos").removeClass("hide").html(e.length)),
    x = 1,
    $.each(t, (function() {
    ...
    $.each(t, (function() {
        var e = $(this).find(".todo-description");
        e.hasClass("line-throught") || e.addClass("line-throught"),
        i.push([$(this).find('input[name="todo_id"]').val(), $(this).find('input[name="todo_order"]').val(), $(this).find('input[name="finished"]').val()])
    }
    )),
    data = {},
...
function delete_todo_item(e, t) {
    requestGetJSON("todo/delete_todo_item/" + t).done((function(t) {
        !0 !== t.success && "true" != t.success || ($(e).parents("li").remove(),
        update_todo_items())
    }
    ))
}
function edit_todo_item(e) {
    requestGetJSON("todo/get_by_id/" + e).done((function(e) {
        var t = $("#__todo");
        t.find('input[name="todoid"]').val(e.todoid),
        t.find('textarea[name="description"]').val(e.description),
        t.modal("show")
    }
    ))
}
...
function do_filter_active(e, t) {
    if ("" !== e && void 0 !== e) {
        ...
        if (i.hasClass("filter-group")) {
            ...
            $('[data-filter-group="' + n + '"]').not(i).removeClass("active"),
        ...
        if (i.not(".dropdown-submenu").hasClass("active")) {
            ...
            s.length > 0 && 0 === s.find("li.active").length && s.removeClass("active"),
            e = ""
        } else
            i.addClass("active");
        return e
    }
    return $("._filters input").val(""),
    $("._filter_data li.active").removeClass("active"),
    $('[data-cview="all"]').parents("li").addClass("active"),
    ""
}
function init_roles_permissions(e, t) {
    if (e = void 0 === e ? $('select[name="role"]').val() : e,
    !($('.member > input[name="isedit"]').length > 0 && void 0 !== e && void 0 === t) && !0 !== $('input[name="administrator"]').prop("checked") && "" !== e) {
            ...
            $.each(a, (function() {
                ...
                $.each(e, (function(e, a) {
                    t.data("name") == e && $.each(a, (function(a, i) {
                        t.find('input[id="' + e + "_" + i + '"]').prop("checked", !0),
                        "view" == i ? t.find("[data-can-view]").change() : "view_own" == i && t.find("[data-can-view-own]").change()
                    }
                    ))
                }
                ))
...
function logout() {
    if ($(".started-timers-top").find("li.timer").length > 0)
        ...
        }).find(".popup-message").addClass("hide"),
        !1;
    window.location.href = admin_url + "authentication/logout"
}
function elFinderBrowser(e, t, a) {
    return tinymce.activeEditor.windowManager.elfinderCallback = e,
...
function init_editor(e, t) {
    ...
    if (0 !== a.length) {
        ...
        if ("true" == isRTL && (i.directionality = "rtl",
        i.plugins.push("directionality")),
        void 0 !== t)
            for (var n in t)
                "append_plugins" != n ? i[n] = t[n] : i.plugins.push(t[n]);
        var s = tinymce.init(i);
        return $(document).trigger("app.editor.initialized"),
        s
    }
}
...
function init_btn_with_tooltips() {
    if (is_mobile()) {
        ...
        $.each(t, (function() {
            var e = $(this).attr("title");
            void 0 === e && (e = $(this).attr("data-title")),
            void 0 !== e && ($(this).find(".btn").eq(0).append(" " + e),
...
function new_task_reminder(e) {
    ...
    t.isInViewport() || $("#task-modal").animate({
...
function edit_reminder(e, t) {
    requestGetJSON("misc/get_reminder/" + e).done((function(t) {
        ...
        0 === a.length && $("body").hasClass("all-reminders") ? ((a = $(".reminder-modal--")).find('input[name="rel_type"]').val(t.rel_type),
        a.find('input[name="rel_id"]').val(t.rel_id)) : $("#task-modal").is(":visible") && ((a = $("#newTaskReminderToggle")).attr("data-edit") && a.attr("data-edit") == e ? (a.slideUp(),
        a.removeAttr("data-edit")) : (a.slideDown(400, (function() {
            fix_task_modal_left_col_height()
        }
        )),
        a.attr("data-edit", e),
        a.isInViewport() || $("#task-modal").animate({
...
function reminderFormHandler(e) {
    ...
    return $.post(e.attr("action"), t).done((function(t) {
        "" !== (t = JSON.parse(t)).message && alert_float(t.alert_type, t.message),
        e.trigger("reinitialize.areYouSure"),
        $("#task-modal").is(":visible") && _task_append_html(t.taskHtml),
...
function toggle_edit_note(e) {
    $("body").find('[data-note-edit-textarea="' + e + '"]').toggleClass("hide"),
    $("body").find('[data-note-description="' + e + '"]').toggleClass("hide")
}
function edit_note(e) {
    ...
    "" !== t && ($.post(admin_url + "misc/edit_note/" + e, {
        ...
        !0 !== (t = JSON.parse(t)).success && "true" != t.success || (alert_float("success", t.message),
        $("body").find('[data-note-description="' + e + '"]').html(t.description))
    }
    )),
    toggle_edit_note(e))
}
...
function fix_kanban_height(e, t) {
    ...
    a.css("max-height", window.innerHeight - e + "px"),
    $(".kan-ban-content").css("min-height", window.innerHeight - e + "px");
    var i = parseInt(a.length);
    $(".container-fluid").css("min-width", i * t + "px")
}
function kanban_load_more(e, t, a, i, n) {
    var s, o = [], l = $('input[name="search"]').val(), d = $(t).attr("data-page"), r = $('[data-col-status-id="' + e + '"]').data("total-pages");
    if (d <= r) {
        var c = $('input[name="sort_type"]')
          , p = $('input[name="sort"]').val();
        0 != c.length && "" !== c.val() && (o.sort_by = c.val(),
        o.sort = p),
        ...
        o.page = d,
        o.page++,
        requestGet(buildUrl(admin_url + a, o)).done((function(a) {
            d++,
...
function check_kanban_empty_col(e) {
    ...
    $.each(t, (function(t, a) {
        0 == $(a).find(e).length ? ($(a).find(".kanban-empty").removeClass("hide"),
        $(a).find(".kanban-load-more").addClass("hide")) : $(a).find(".kanban-empty").addClass("hide")
    }
    ))
}
function init_kanban(e, t, a, i, n, s) {
    if (0 !== $("#kan-ban").length) {
        ...
        0 != r.length && "" !== r.val() && (l.sort_by = r.val(),
        l.sort = c),
        l.kanban = !0,
        e = admin_url + e,
        e = buildUrl(e, l);
        ...
        if (p.length > 0) {
            ...
            p.each((function(e, t) {
                _.push({
                    status: $(t).data("col-status-id"),
                    total: parseInt($(t).attr("data-total"))
                })
            }
            )),
            ...
            $("#kan-ban").load(e, (function() {
                ...
                $(".status").sortable({
                    ...
                    start: function(e, t) {
                        ...
                        $(t.helper).addClass("tilt"),
                        $(t.helper).find(".panel-body").css("background", "#fbfbfb"),
                        tilt_direction($(t.helper))
                    },
                    stop: function(e, t) {
                        $("body").removeAttr("style"),
                        $(t.helper).removeClass("tilt"),
                        $("html").off("mousemove", $(t.helper).data("move_handler")),
                        $(t.helper).removeData("move_handler")
                    },
                    update: function(e, a) {
                        t(a, this)
                    }
...
function kan_ban_sort(e, t) {
    ...
    var a = $('input[name="sort"]')
      , i = a.val().toLowerCase();
    a.val("asc" == i ? "DESC" : "ASC"),
    init_kan_ban_sort_icon(a.val(), e),
    t()
}
function init_kan_ban_sort_icon(e, t) {
    $("body").find(".kanban-sort-icon").remove(),
    $("body").find("." + t).prepend(" <i class='kanban-sort-icon fa fa-sort-amount-" + e.toLowerCase() + "'></i>")
}
function init_newsfeed_form() {
        ...
        return $.post(this.action, $(this).serialize()).done((function(e) {
            if ((e = JSON.parse(e)).postid) {
                if (newsFeedDropzone.getQueuedFiles().length > 0)
                    return newsFeedDropzone.options.url = admin_url + "newsfeed/add_post_attachments/" + e.postid,
                    void newsFeedDropzone.processQueue();
                newsfeed_new_post(e.postid),
    ...
    newsFeedDropzone = new Dropzone("#new-post-form",appCreateDropzoneOptions({
        ...
        success: function(e, t) {
            0 === this.getUploadingFiles().length && 0 === this.getQueuedFiles().length && (newsfeed_new_post((t = JSON.parse(t)).postid),
            clear_newsfeed_post_area(),
            this.removeAllFiles())
        }
    }))
...
function load_post_likes(e) {
    track_load_post_likes <= post_likes_total_pages && ($.post(admin_url + "newsfeed/load_likes_modal", {
        ...
        $("#modal_post_likes_wrapper").append(e)
    }
    )),
...
function load_comment_likes(e) {
    track_load_comment_likes <= comment_likes_total_pages && ($.post(admin_url + "newsfeed/load_comment_likes_model", {
        ...
        $("#modal_comment_likes_wrapper").append(e)
    }
    )),
...
function load_more_comments(e) {
    ...
    a <= i && ($.post(admin_url + "newsfeed/init_post_comments/" + t, {
        ...
        $(e).data("track-load-comments", a),
        $('[data-comments-postid="' + t + '"] .load-more-comments').before(i)
    }
    )),
    a++,
    $(e).find('input[name="page"]').val(a),
    a >= i - 1 && ($(e).addClass("hide"),
...
function add_comment(e) {
    ...
    $.post(admin_url + "newsfeed/add_comment", {
        ...
        !0 !== (a = JSON.parse(a)).success && "true" != a.success || ($(e).val(""),
        $("body").find('[data-comments-postid="' + t + '"] .post-comment').length > 0 ? $("body").find('[data-comments-postid="' + t + '"] .post-comment').prepend(a.comment) : refresh_post_comments(t))
    }
    ))
}
    ...
    if ("" !== t) {
        ...
        $.post(admin_url + "leads/" + a, i).done((function(a) {
            if (!0 === (a = JSON.parse(a)).success || "true" == a.success) {
                ...
                i.append('<option value="' + a.id + '">' + t + "</option>"),
                i.selectpicker("val", a.id),
                i.selectpicker("refresh"),
                i.parents(".form-group").removeClass("has-error")
            }
        }
        ))
    }
...
function init_lead(e, t) {
    $("#task-modal").is(":visible") && $("#task-modal").modal("hide"),
    init_lead_modal_data(e, void 0, t) && $("#lead-modal").modal("show")
}
...
function validate_lead_convert_to_client_form() {
    var e = {
        ...
        password: {
            required: {
                depends: function(e) {
                    if (!1 === $('input[name="send_set_password_email"]').prop("checked"))
                        return !0
                }
            }
        },
    ...
    1 == app.options.company_is_required && (e.company = "required"),
    appValidateForm($("#lead_to_client_form"), e)
}
function lead_profile_form_handler(e) {
    var t = (e = $(e)).serialize();
    $("#lead-modal").find('input[name="leadid"]').val();
    return $(".lead-save-btn").addClass("disabled").attr("disabled", !0),
    $.post(e.attr("action"), t).done((function(e) {
        "" !== (e = JSON.parse(e)).message && alert_float("success", e.message),
        e.proposal_warning && 0 != e.proposal_warning ? ($("body").find("#lead_proposal_warning").removeClass("hide"),
        $("body").find("#lead-modal").animate({
            scrollTop: 0
        }, 800)) : _lead_init_data(e, e.id),
        $.fn.DataTable.isDataTable(".table-leads") ? table_leads.DataTable().ajax.reload(null, !1) : $("body").hasClass("kan-ban-body") && leads_kanban()
    }
    )).fail((function(e) {
        return alert_float("danger", e.responseText),
        !1
    }
    )),
    !1
...
function update_all_proposal_emails_linked_to_lead(e) {
    $.post(admin_url + "leads/update_all_proposal_emails_linked_to_lead/" + e, {
        ...
        (t = JSON.parse(t)).success && alert_float("success", t.message),
        init_lead_modal_data(e)
    }
    ))
}
function _lead_init_data(e, t) {
    ...
    validate_lead_form();
    if (["#tab_lead_profile", "#attachments", "#lead_notes", "#lead_activity", "#gdpr"].indexOf(a) > -1 && (window.location.hash = a),
    ...
    "" !== t && void 0 !== t) {
        ...
        leadAttachmentsDropzone = new Dropzone("#lead-attachment-upload",appCreateDropzoneOptions({
            sending: function(e, a, i) {
                i.append("id", t),
                0 === this.getQueuedFiles().length && i.append("last_file", !0)
            },
            success: function(e, t) {
                t = JSON.parse(t),
                0 === this.getUploadingFiles().length && 0 === this.getQueuedFiles().length && _lead_init_data(t, t.id)
            }
        })),
        ...
        $("[lead-is-junk-or-lost]").length > 0 && $(".form-group-select-input-status").find(".req").remove()
    }
}
...
function print_expense_information() {
    ...
    e.find("#expenseReceipt").remove(),
    e.find("#amountWrapper").css("margin-bottom", "15px");
    var i = _create_print_window(a);
    i.document.write("<html><head><title>" + app.lang.expense + "</title>"),
    _add_print_window_default_styles(i),
    i.document.write("</head><body>"),
    i.document.write("<h1>" + a + "</h1>"),
    i.document.write('<div id="#tab_expense">' + e.html() + "</div>"),
...
function leads_kanban_update(e, t) {
    if (t === e.item.parent()[0]) {
        var a = {
            status: $(e.item.parent()[0]).attr("data-lead-status-id"),
            leadid: $(e.item).attr("data-lead-id"),
            order: []
        };
...
function update_kan_ban_total_when_moving(e, t) {
    if (e.sender && (a = $(e.sender.closest(".kan-ban-col"))).data("status-id") != t) {
        var a, i = $('[data-col-status-id="' + t + '"]');
        i.attr("data-total", parseInt(i.attr("data-total")) + 1),
        (a = $(e.sender.closest(".kan-ban-col"))).attr("data-total", parseInt(a.attr("data-total")) - 1)
    }
}
...
function lead_mark_as_lost(e) {
    requestGetJSON("leads/mark_as_lost/" + e).done((function(t) {
        !0 !== t.success && "true" != t.success || (alert_float("success", t.message),
        $("body").find("tr#lead_" + e).remove(),
        $("body").find('#kan-ban li[data-lead-id="' + e + '"]').remove()),
        _lead_init_data(t, t.id)
    }
    )).fail((function(e) {
        alert_float("danger", e.responseText)
...
function lead_unmark_as_lost(e) {
    requestGetJSON("leads/unmark_as_lost/" + e).done((function(e) {
        !0 !== e.success && "true" != e.success || alert_float("success", e.message),
        _lead_init_data(e, e.id)
    }
    )).fail((function(e) {
        alert_float("danger", e.responseText)
    }
...
function convert_lead_to_customer(e) {
    ...
    t.on(a, (function() {
        t.find(".data").html(""),
        requestGet("leads/get_convert_data/" + e).done((function(e) {
...
function leads_bulk_action(e) {
    if (confirm_delete()) {
        var t = $("#mass_delete").prop("checked")
          ...
          , i = {};
        if (0 == t || void 0 === t) {
            if (i.lost = $("#leads_bulk_mark_lost").prop("checked"),
...
function update_comments_count() {
    ...
    $(".total_comments").text(e),
    0 === e ? $(".total_comments").addClass("hide") : $(".total_comments").removeClass("hide")
}
...
function edit_proposal_comment(e) {
    ...
    "" != t && ($.post(admin_url + "proposals/edit_comment/" + e, {
        ...
        1 == (a = JSON.parse(a)).success && (alert_float("success", a.message),
        $("body").find('[data-proposal-comment="' + e + '"]').html(nl2br(t)))
    }
    )),
    toggle_proposal_comment_edit(e))
}
function toggle_proposal_comment_edit(e) {
    $("body").find('[data-proposal-comment="' + e + '"]').toggleClass("hide"),
    $("body").find('[data-proposal-comment-edit-textarea="' + e + '"]').toggleClass("hide")
}
function proposal_convert_template(e) {
    ...
    requestGet("proposals/get_" + t + "_convert_data/" + proposal_id).done((function(e) {
        $(".proposal-pipeline-modal").is(":visible") && $(".proposal-pipeline-modal").modal("hide"),
        $("#convert_helper").html(e),
        $("#convert_to_" + t).modal({
            show: !0,
            backdrop: "static"
        }),
...
function save_proposal_content(e) {
    ...
    $.post(admin_url + "proposals/save_proposal_data", a).done((function(a) {
        a = JSON.parse(a),
        void 0 !== e && alert_float("success", a.message),
        t.save()
    }
    )).fail((function(e) {
...
function init_table_tickets(e) {
    ...
    if (0 !== $("body").find(".tickets-table").length) {
        ...
        var n = [0]
          , s = admin_url + "tickets";
        if ($("body").hasClass("tickets-page") && (s += "?bulk_actions=true"),
        _table_api = initDataTable(".tickets-table", s, n, n, t, [i, "desc"]),
        _table_api && $("body").hasClass("dashboard")) {
            var o = [4, i, 5, 6];
            for (var l in o)
                _table_api.column(o[l]).visible(!1, !1);
...
function do_task_checklist_items_height(e) {
    ...
    $.each(e, (function() {
        var e = $(this).val();
        $(this).outerHeight() < this.scrollHeight + parseFloat($(this).css("borderTopWidth")) + parseFloat($(this).css("borderBottomWidth")) && $(this).height(0).height(this.scrollHeight),
...
function recalculate_checklist_items_progress() {
    var e = $('input[name="checklist-box"]:checked').length
      ...
      , a = 0
      , i = $(".task-progress-bar");
    if ($(".task-total-checklist-completed").text(e),
    0 == t ? $("#task-no-checklist-items").removeClass("hide") : $("#task-no-checklist-items").addClass("hide"),
    !(t >= 2))
        return i.parents(".progress").addClass("hide"),
...
function remove_checklist_item_template(e) {
    requestGetJSON("tasks/remove_checklist_item_template/" + e).done((function(t) {
        if (!0 === t.success || "true" == t.success) {
            ...
            a.selectpicker("refresh"),
            1 === a.find("option").length && (a.selectpicker("destroy"),
...
function save_checklist_item_template(e, t) {
    ...
    $.post(admin_url + "tasks/save_checklist_item_template", {
        ...
        i.find('select option[value=""]').after('<option value="' + e.id + '">' + a.trim() + "</option>"),
        i.removeClass("hide"),
        i.find("select").selectpicker("refresh")
    }
    ))
}
function update_checklist_order() {
    ...
    if (0 !== t.length) {
        var a = 1;
        $.each(t, (function() {
            e.push([$(this).data("checklist-id"), a]),
            a++
        }
        ));
        var i = {};
        i.order = e,
        $.post(admin_url + "tasks/update_checklist_order", i)
    }
}
...
function update_task_checklist_item(e) {
    ...
    return setTimeout((function() {
        ...
        $.post(admin_url + "tasks/update_checklist_item", {
            ...
            "" === a && $("#checklist-items").find('.checklist[data-checklist-id="' + i + '"]').remove()
        }
        ))
    }
    ), 300),
...
function delete_checklist_item(e, t) {
    requestGetJSON("tasks/delete_checklist_item/" + e).done((function(e) {
        !0 !== e.success && "true" != e.success || ($(t).parents(".checklist").remove(),
...
function _task_attachments_more_and_less_checks() {
    ...
    0 === t.length ? e.remove() : 2 == t.length && a.hasClass("hide") ? $("body").find("#show-more-less-task-attachments-col").remove() : 0 !== $(".task_attachments_wrapper .task-attachment-col:visible").length || a.hasClass("hide") || a.click(),
...
function remove_task_attachment(e, t) {
    confirm_delete() && requestGetJSON("tasks/remove_task_attachment/" + t).done((function(e) {
        !0 !== e.success && "true" != e.success || $('[data-task-attachment-id="' + t + '"]').remove(),
        _task_attachments_more_and_less_checks(),
        e.comment_removed && $("#comment_" + e.comment_removed).remove()
    }
    ))
}
function add_task_comment(e) {
    var t = {};
    taskCommentAttachmentDropzone.files.length > 0 ? taskCommentAttachmentDropzone.processQueue(e) : (tinymce.activeEditor ? t.content = tinyMCE.activeEditor.getContent() : (t.content = $("#task_comment").val(),
    t.no_editor = !0),
    t.taskid = e,
    $.post(admin_url + "tasks/add_task_comment", t).done((function(e) {
        _task_append_html((e = JSON.parse(e)).taskHtml),
...
function remove_task_comment(e) {
    confirm_delete() && requestGetJSON("tasks/remove_comment/" + e).done((function(t) {
        !0 !== t.success && "true" != t.success || ($('[data-commentid="' + e + '"]').remove(),
        $('[data-comment-attachment="' + e + '"]').remove(),
        _task_attachments_more_and_less_checks())
    }
    ))
}
...
function task_mark_as(e, t, a) {
    ...
    requestGetJSON(a).done((function(a) {
        $("body").find(".dt-loader").remove(),
        !0 !== a.success && "true" != a.success || (reload_tasks_tables(),
...
function task_change_priority(e, t) {
    ...
    requestGetJSON(url).done((function(e) {
        !0 !== e.success && "true" != e.success || (reload_tasks_tables(),
        a && _task_append_html(e.taskHtml))
    }
    ))
}
...
function new_task(e, t) {
    ...
    var a = $("#lead-modal");
    a.is(":visible") && (-1 === (e += "&opened_from_lead_id=" + a.find('input[name="leadid"]').val()).indexOf("?") && (e = e.replace("&", "?")),
    a.modal("hide"));
    var i = $("#task-modal");
    i.is(":visible") && i.modal("hide");
    var n = $("#_task_modal");
    n.is(":visible") && n.modal("hide"),
    requestGet(e).done((function(e) {
        $("#_task").html(e),
        $("body").find("#_task_modal").modal({
            show: !0,
            backdrop: "static"
        }),
        $("#timer-select-task").is(":visible") && ($(".system-popup-close").click(),
        window._timer_id = t)
    }
    )).fail((function(e) {
        alert_float("danger", e.responseText)
...
function new_task_from_relation(e, t, a) {
    void 0 === t && void 0 === a && (a = $(e).data("new-rel-id"),
    t = $(e).data("new-rel-type")),
    new_task(admin_url + "tasks/task?rel_id=" + a + "&rel_type=" + t)
}
...
function task_form_handler(e) {
    ...
    return $.ajax({
        ...
        if (!0 !== (e = JSON.parse(e)).success && "true" != e.success || alert_float("success", e.message),
        window._timer_id)
            return requestGet(admin_url + "/tasks/get_task_by_id/" + e.id).done((function(e) {
                $('[data-timer-id="' + window._timer_id + '"').click();
                var t = '<option value="' + (e = JSON.parse(e)).id + '" title="' + e.name + '" selected>' + e.name + "</option>";
                $("#timer_add_task_id").append(t),
        ...
        if ($("body").hasClass("project")) {
            ...
            i && (a.group = i),
            n && (a.exclude_completed = n),
            a.taskid = e.id,
            window.location.href = buildUrl(t[0], a)
        } else
            $("#_task_modal").attr("data-task-created", !0),
            $("#_task_modal").modal("hide"),
            init_task_modal(e.id),
            reload_tasks_tables(),
            $("body").hasClass("kan-ban-body") && $("body").hasClass("tasks") && tasks_kanban()
    }
    )).fail((function(e) {
...
function system_popup(e) {
    ...
    var t = $("<div/>", {
      ...
      , a = "";
    return a += '<div class="popup-wrapper fadeIn animated">',
...
function init_task_modal(e, t) {
    var a = ""
      , i = $("#lead-modal")
      , n = $("#_task_modal");
    i.is(":visible") ? (a += "?opened_from_lead_id=" + i.find('input[name="leadid"]').val(),
    i.modal("hide")) : null != n.attr("data-lead-id") && (a += "?opened_from_lead_id=" + n.attr("data-lead-id")),
    requestGet("tasks/get_task_data/" + e + a).done((function(e) {
        _task_append_html(e),
...
function _task_append_html(e) {
    ...
    setTimeout((function() {
        t.modal("show"),
        t.is(":visible") && init_tags_inputs(),
        init_form_reminder("task"),
        fix_task_modal_left_col_height(),
        is_mobile() && init_new_task_comment(!0)
    }
    ), 150)
}
...
function _init_timers_top_html(e) {
    ...
    e.total_timers > 0 ? $("#top-timers").find("i").addClass("tw-animate-spin-slow") : $("#top-timers").find("i").removeClass("tw-animate-spin-slow"),
...
function cancel_edit_comment(e) {
    var t = $('[data-edit-comment="' + e + '"]');
    tinymce.remove('[data-edit-comment="' + e + '"] textarea'),
    t.addClass("hide"),
...
function save_edited_comment(e, t) {
    ...
    a.id = e,
    a.task_id = t,
    a.content = $('[data-edit-comment="' + e + '"]').find("textarea").val(),
    is_ios() && (a.no_editor = !0),
    $.post(admin_url + "tasks/edit_comment", a).done((function(t) {
        !0 === (t = JSON.parse(t)).success || "true" == t.success ? (alert_float("success", t.message),
        _task_append_html(t.taskHtml)) : cancel_edit_comment(e),
        tinymce.remove('[data-edit-comment="' + e + '"] textarea')
    }
    ))
}
    ...
    if (t === e.item.parent()[0]) {
        ...
        setTimeout((function() {
            $.post(admin_url + "tasks/update_order", i).done((function(t) {
                update_kan_ban_total_when_moving(e, i.status),
                tasks_kanban()
            }
            ))
        }
...
function edit_task_inline_description(e, t) {
    ...
    $(e).hasClass("editor-initiated") ? $(e).removeClass("editor-initiated") : ($(e).addClass("editor-initiated"),
    $.Shortcuts.stop(),
    tinymce.init({
        branding: !1,
        toolbar: !1,
        ...
        plugins: ["quickbars", "link", "table", "true" == isRTL ? " directionality" : ""],
...
function tasks_bulk_action(e) {
    if (confirm_delete()) {
        ...
        if (0 == i || void 0 === i) {
            ...
            if (a.milestone = o.length ? o.selectpicker("val") : "",
...
function clear_billing_and_shipping_details() {
    for (var e in billingAndShippingFields)
        billingAndShippingFields[e].indexOf("country") > -1 ? $('select[name="' + billingAndShippingFields[e] + '"]').selectpicker("val", "") : ($('input[name="' + billingAndShippingFields[e] + '"]').val(""),
        $('textarea[name="' + billingAndShippingFields[e] + '"]').val("")),
        "billing_country" == billingAndShippingFields[e] && ($('input[name="include_shipping"]').prop("checked", !1),
...
function add_item_to_preview(e) {
    requestGetJSON("invoice_items/get_item_by_id/" + e).done((function(e) {
        ...
        var t = [];
        e.taxname && e.taxrate && t.push(e.taxname + "|" + e.taxrate),
        e.taxname_2 && e.taxrate_2 && t.push(e.taxname_2 + "|" + e.taxrate_2),
        $(".main select.tax").selectpicker("val", t),
        $('.main input[name="unit"]').val(e.unit);
...
function _set_item_preview_custom_fields_array(e) {
    for (var t = ["input", "number", "date_picker", "date_picker_time", "colorpicker"], a = 0; a < e.length; a++) {
        ...
        if ($.inArray(i.type, t) > -1)
            $('tr.main td[data-id="' + i.id + '"] input').val(i.value).trigger("change");
        else if ("textarea" == i.type)
            $('tr.main td[data-id="' + i.id + '"] textarea').val(i.value);
...
function clear_item_preview_values(e) {
    ...
    a.find('input[name="unit"]').val(""),
    a.find("#main-optional").prop("checked", !1),
    a.find("#main-optional").trigger("change"),
    a.find("#main-optional-choosen").prop("checked", !0),
...
function add_item_to_table(e, t, a, i) {
    if ("" !== (e = void 0 === e || "undefined" == e ? get_item_preview_values() : e).description || "" !== e.long_description || "" !== e.rate) {
        ...
        lastAddedItemKey = s,
        n += '<tr class="sortable item" data-merge-invoice="' + a + '" data-bill-expense="' + i + '">',
        n += '<td class="dragger">',
        isNaN(e.qty) && (e.qty = 1),
        ("" === e.rate || isNaN(e.rate)) && (e.rate = 0);
        var o = e.rate * e.qty
        ...
        return get_taxes_dropdown_template(l, e.taxname).done((function(a) {
            ...
            n += "</td>",
            n += '<td class="bold description"><textarea name="newitems[' + s + '][description]" class="form-control" rows="5">' + e.description + "</textarea>",
            n += '<div class="tw-mt-1.5">',
            n += '<div class="checkbox checkbox-info">',
            n += '<input class="optional-item-checkbox" ' + (e.is_optional ? " checked" : "") + ' value="1" id="' + s + '-optional" type="checkbox" name="newitems[' + s + '][is_optional]" data-index="' + s + '" />',
            n += '<label for="' + s + '-optional">' + app.lang.item_is_optional + "</label>",
            n += "</div>",
            n += '<div class="checkbox" style="' + (e.is_optional ? "" : "display: none; ") + '">',
            n += '<input class="optional-choose-item-checkbox" ' + (e.is_selected ? " checked" : "") + ' value="1" id="' + s + '-optional-choosen" type="checkbox" name="newitems[' + s + '][is_selected]" />',
            n += '<label for="' + s + '-optional-choosen">' + app.lang.item_is_selected + "</label>",
            n += "</div>",
            n += "</div>",
            n += "</td>",
            ...
            l.length > 0 && $.each(l, (function() {
                ...
                if (a.is(":checkbox")) {
                    ...
                    $.each(l, (function(e, t) {
                        ...
                        $(this).attr("id", a).attr("name", i).next("label").attr("for", a),
                    ...
                    "1" == $(a).attr("data-custom-field-required") && (r = !0);
            ...
            n += "</td>",
            n += '<td class="rate"><input type="number" data-toggle="tooltip" title="' + app.lang.item_field_not_formatted + '" onblur="calculate_total();" onchange="calculate_total();" name="newitems[' + s + '][rate]" value="' + e.rate + '" class="form-control"></td>',
            n += '<td class="taxrate">' + a + "</td>",
            n += '<td class="amount" align="right">' + format_money(o, !0) + "</td>",
            n += '<td><a href="#" class="btn btn-danger pull-left !tw-px-3" onclick="delete_item(this,' + t + '); return false;"><i class="fa fa-trash"></i></a></td>',
            n += "</tr>",
            ...
            r && $(".invoice-form").length ? validate_invoice_form() : r && $(".estimate-form").length ? validate_estimate_form() : r && $(".proposal-form").length ? validate_proposal_form() : r && $(".credit-note-form").length && validate_credit_note_form(),
            "undefined" != i && i || ($('select[name="task_select"]').find('[value="' + c + '"]').remove(),
...
function deselect_ajax_search(e) {
    ...
    t.html("").append('<option value=""></option>').selectpicker("val", "multiple" == t.attr("multiple") ? [] : ""),
    a.removeClass("ajax-remove-values-option").find(".ajax-clear-values").remove(),
    setTimeout((function() {
        t.trigger("selected.cleared.ajax.bootstrap.select", e),
        t.trigger("change").data("AjaxBootstrapSelect").list.cache = {}
    }
    ), 50)
}
...
function save_ei_items_order() {
    ...
    if (!i)
        return !1;
    $.each(t, (function() {
        n.push([$(this).data("item-id"), a]),
        $(this).find("td.item_no").html(a),
        a++
    }
    )),
    setTimeout((function() {
...
function get_item_preview_values() {
    var e = {};
    return e.description = $('.main textarea[name="description"]').val(),
    ...
    e.is_optional = $("#main-optional").prop("checked") ? 1 : 0,
    e.is_selected = $("#main-optional-choosen").prop("checked") ? 1 : 0,
    e
}
function calculate_total() {
    if ($("body").hasClass("no-calculate-total"))
        return !1;
    var e, t, a, i, n, s, o = {}, l = 0, d = 0, r = 1, c = 0, p = $(".table.has-calculations tbody tr.item"), _ = $("#discount_area"), m = $('input[name="adjustment"]').val(), u = $('input[name="discount_percent"]').val(), f = $('input[name="discount_total"]').val(), h = $(".discount-total-type.selected"), v = $('select[name="discount_type"]').val();
    $(".tax-area").remove(),
    $.each(p, (function() {
        "" === (r = $(this).find("[data-quantity]").val()) && (r = 1,
        $(this).find("[data-quantity]").val(1));
        var d = $(this).find(".optional-item-checkbox").prop("checked")
          , c = $(this).find(".optional-choose-item-checkbox").prop("checked");
        if (n = accounting.toFixed($(this).find("td.rate input").val() * r, app.options.decimal_places),
        n = parseFloat(n),
        ...
        l += n,
        i = $(this),
        (a = $(this).find("select.tax").selectpicker("val")) && $.each(a, (function(a, l) {
            t = i.find('select.tax [value="' + l + '"]').data("taxrate"),
            e = n / 100 * t,
            o.hasOwnProperty(l) ? o[l] = o[l] += e : 0 != t && (s = l.split("|"),
            tax_row = '<tr class="tax-area"><td>' + s[0] + "(" + t + '%)</td><td id="tax_id_' + slugify(l) + '"></td></tr>',
            $(_).after(tax_row),
            o[l] = e)
        }
        ))
    ...
    $.each(o, (function(e, t) {
        if ("" !== u && 0 != u && "before_tax" == v && h.hasClass("discount-type-percent"))
            total_tax_calculated = t * u / 100,
            t -= total_tax_calculated;
...
function exclude_tax_from_amount(e, t) {
    return totalTax = accounting.toFixed(t * e / (100 + e), app.options.decimal_places),
    accounting.toFixed(t - totalTax, app.options.decimal_places)
}
...
function delete_invoice_attachment(e) {
    confirm_delete() && requestGet("invoices/delete_attachment/" + e).done((function(t) {
        1 == t && ($("body").find('[data-attachment-id="' + e + '"]').remove(),
...
function init_invoices_total(e) {
    var t = $("#invoices_total");
    if (0 !== t.length) {
        var a = $(".invoices-total-inline")
          , i = $(".invoices-total");
        if (!$("body").hasClass("invoices-total-manual") || void 0 !== e || i.hasClass("initialized"))
            if (a.length > 0 && i.hasClass("initialized"))
                a.removeClass("invoices-total-inline");
            else {
                i.addClass("initialized");
                var n = $("body").find('select[name="invoices_total_years"]').selectpicker("val")
                  , s = [];
                $.each(n, (function(e, t) {
                    "" !== t && s.push(t)
                }
                ...
                var o = {
                    ...
                    years: s,
                    init_total: !0,
                    display_type: t.attr("data-type")
                }
                  , l = $('input[name="project_id"]').val()
                  , d = $('.customer_profile input[name="userid"]').val();
                void 0 !== l ? o.project_id = l : void 0 !== d && (o.customer_id = d),
                $.post(admin_url + "invoices/get_invoices_total", o).done((function(e) {
                    t.html(e)
                }
                ))
            }
...
function estimates_pipeline_update(e, t) {
    if (t === e.item.parent()[0]) {
        var a = {
            estimateid: $(e.item).attr("data-estimate-id"),
            status: $(e.item.parent()[0]).attr("data-status-id"),
            order: []
        };
...
function proposals_pipeline_update(e, t) {
    if (t === e.item.parent()[0]) {
        var a = {
            order: [],
            status: $(e.item.parent()[0]).attr("data-status-id"),
            proposalid: $(e.item).attr("data-proposal-id")
        };
        $.each($(e.item).parents(".pipeline-status").find("li"), (function(e, t) {
...
function proposal_pipeline_open(e) {
    "" !== e && requestGet("proposals/pipeline_open/" + e).done((function(e) {
        ...
        $("#proposal").html(e),
        t ? $("#proposal").find(".modal.proposal-pipeline-modal").removeClass("fade").addClass("in").css("display", "block") : $(".proposal-pipeline-modal").modal({
            show: !0,
            backdrop: "static",
            keyboard: !1
        })
...
function estimate_pipeline_open(e) {
    "" !== e && requestGet("estimates/pipeline_open/" + e).done((function(e) {
        ...
        $("#estimate").html(e),
        t ? $("#estimate").find(".modal.estimate-pipeline").removeClass("fade").addClass("in").css("display", "block") : $(".estimate-pipeline").modal({
            show: !0,
            backdrop: "static",
            keyboard: !1
        })
    ...
    confirm_delete() && requestGetJSON("misc/delete_note/" + t).done((function(t) {
        if (!0 === t.success || "true" == t.success) {
            ...
            var a = $("#sales-notes-wrapper")
              ...
              , n = $(".notes-total");
            a.attr("data-total", i),
            i <= 0 ? n.addClass("hide") : n.html('<span class="badge">' + i + "</span>")
        }
    }
    ))
}
...
function save_sales_number_settings(e) {
    ...
    $.post($(e).data("url"), t).done((function(e) {
        (e = JSON.parse(e)).success && e.message && (alert_float("success", e.message),
        $("#prefix").html(t.prefix))
    }
    ))
}
function do_prefix_year(e) {
    ...
    void 0 !== t && $.each(t, (function(e, a) {
        if (4 == a.length) {
            var i = $("#prefix_year");
            if (i.hasClass("format-n-yy"))
                a = a.substr(-2);
            else if (i.hasClass("format-mm-yyyy")) {
                var n;
                "d-m-Y" == app.options.date_format || "d/m/Y" == app.options.date_format || "Y-m-d" == app.options.date_format || "d.m.Y" == app.options.date_format ? n = 1 : "m-d-Y" != app.options.date_format && "m.d.Y" != app.options.date_format && "m/d/Y" != app.options.date_format || (n = 0),
...
function unformat_date(e) {
    var t = _split_formatted_date_by_separator(e)
      ...
      , i = 0
      , n = 2;
    return "d-m-Y" == app.options.date_format || "d/m/Y" == app.options.date_format || "d.m.Y" == app.options.date_format ? (n = 0,
    a = 1,
    i = 2) : "m-d-Y" != app.options.date_format && "m.d.Y" != app.options.date_format && "m/d/Y" != app.options.date_format || (n = 1,
    a = 0,
    i = 2),
    t[i] + "-" + t[a] + "-" + t[n]
}
function _split_formatted_date_by_separator(e) {
    var t;
    return e.indexOf(".") > -1 ? t = e.split(".") : e.indexOf("-") > -1 ? t = e.split("-") : e.indexOf("/") > -1 && (t = e.split("/")),
    t
}
function init_tabs_scrollable() {
    "true" != isRTL ? ($(window).width() <= 768 && $("body").find(".toggle_view").remove(),
    $(".horizontal-scrollable-tabs").horizontalTabs()) : ($(".arrow-left, .arrow-right").css("display", "none"),
...
function set_notification_read_inline(e) {
    requestGet("misc/set_notification_read_inline/" + e).done((function() {
        ...
        t.find(".notification-handler").removeClass("unread-notification"),
        t.find(".not-mark-as-read-inline").tooltip("destroy").remove()
    }
    ))
}
function mark_all_notifications_as_read_inline() {
    requestGet("misc/mark_all_notifications_as_read_inline/").done((function() {
        ...
        e.find(".notification-handler").removeClass("unread-notification"),
        e.find(".not-mark-as-read-inline").tooltip("destroy").remove()
    }
    ))
}
...
function calendar_form_handler(e) {
    return $.post(e.action, $(e).serialize()).done((function(e) {
        !0 !== (e = JSON.parse(e)).success && "true" != e.success || (alert_float("success", e.message),
        setTimeout((function() {
            ...
            i.length > 0 && $.each(i, (function(e, a) {
                ...
                $.notify("", {
                    ...
                    requestGet("misc/set_desktop_notification_read/" + a).done((function(e) {
                        ...
                        var n = i.text();
                        n = n.trim(),
                        (n -= 1) > 0 ? (document.title = "(" + n + ") " + doc_initial_title,
                        i.html(n)) : (document.title = doc_initial_title,
                        i.addClass("hide"))
                    }
                    ))
                }
                    ...
                    window.focus(),
                    setTimeout((function() {
                        t.find(i + " .notification-link").addClass("desktopClick").click(),
                        e.target.close()
                    }
                    ), 70)
                }
...
function init_new_task_comment(e) {
    tinymce.get("task_comment") && tinymce.remove("#task_comment"),
    ...
    taskCommentAttachmentDropzone = new Dropzone("#task-comment-form",appCreateDropzoneOptions({
        ...
        sending: function(e, t, a) {
            a.append("taskid", $("#addTaskCommentBtn").attr("data-comment-task-id")),
            tinyMCE.activeEditor ? a.append("content", tinyMCE.activeEditor.getContent()) : a.append("content", $("#task_comment").val())
        },
        success: function(e, t) {
            t = JSON.parse(t),
            0 === this.getUploadingFiles().length && 0 === this.getQueuedFiles().length && (_task_append_html(t.taskHtml),
            tinymce.remove("#task_comment"))
        }
    }));
    ...
    var a = $("#task-modal #taskid").val();
    t.content_style = "span.mention {        background-color: #eeeeee;        padding: 3px;    }",
    t.setup = function(e) {
        initializeTinyMceMentions(e, (function() {
            return $.getJSON(admin_url + "tasks/get_staff_names_for_mentions/" + a)
        }
        ))
    }
    ,
    init_editor("#task_comment", t)
}
function initializeTinyMceMentions(e, t) {
    Object.hasOwn(e, "perfexCommands") || (e.perfexCommands = {});
    let a = null;
    e.perfexCommands.getUsersForMention = async function() {
        if (Array.isArray(a))
            return a;
        let e = await t();
        return a = e.map((e => ({
    ...
    ,
    e.perfexCommands.insertMentionUser = function(t, a, i) {
        e.selection.setRng(i || 0),
        e.insertContent('<span class="mention" contenteditable="false" data-mention-id="' + t + '">@' + a + "</span>&nbsp;")
    }
    ,
    e.ui.registry.addAutocompleter("mentions", {
        ...
        columns: 1,
        fetch: function(t) {
            return new Promise((t => t(e.perfexCommands.getUsersForMention())))
        },
        onAction: function(t, a, i) {
            e.perfexCommands.getUsersForMention().then((n => {
                let s = n.find((e => e.value == i));
                e.perfexCommands.insertMentionUser(i, s.text, a),
                t.hide()
            }
            ))
        }
...
function init_ajax_search(e, t, a, i) {
    ...
    if (n.length) {
        ...
        n.data("empty-title") && (s.locale.emptyTitle = n.data("empty-title")),
        n.selectpicker().ajaxSelectPicker(s)
    }
}
function merge_field_format_url(e, t, a, i) {
    return e && e.indexOf("%7B") > -1 && e.indexOf("%7D") > -1 && (e = e.replaceAll("%7B", "{").replaceAll("%7D", "}")),
    e
}
...
function salesExtenalFileUpload(e, t) {
    ...
    $.post(admin_url + "misc/add_sales_external_attachment", a).done((function() {
        "estimate" == a.type ? $("body").hasClass("estimates-pipeline") ? estimate_pipeline_open(a.rel_id) : init_estimate(a.rel_id) : "proposal" == a.type ? $("body").hasClass("proposals-pipeline") ? proposal_pipeline_open(a.rel_id) : init_proposal(a.rel_id) : "function" == typeof window["init_" + a.type] && window["init_" + a.type](a.rel_id),
...
function requestGetJSON(e, t) {
    return (t = void 0 === t ? {} : t).dataType = "json",
    requestGet(e, t)
}
function update_templates_count(e) {
    var t = $(".templates-wrapper").length;
    $(".total_templates").text(t),
    0 === t ? $(".total_templates").addClass("hide") : $(".total_templates").removeClass("hide")
}
...
function delete_template(e, t, a) {
    confirm_delete() && $.post(admin_url + "templates/delete/" + a).done((function(a) {
        !0 !== (a = JSON.parse(a)).success && "true" != a.success || ("proposals" === t ? $(e).parents(".proposal-templates-wrapper").html("") : "contracts" === t && $(e).parents(".contract-templates-wrapper").html(""),
        get_templates(t))
    }
    ))
}
function insert_template(e, t, a) {
    requestGetJSON(admin_url + "templates/index/" + a).done((function(e) {
        var a = e.data;
        tinymce.activeEditor.execCommand("mceInsertContent", !1, a.content),
        "proposals" == t ? $('a[aria-controls="tab_proposal"]').click() : "contracts" == t && $('a[aria-controls="tab_content"]').click(),
...
function retrieve_imap_folders(e, t) {
    var a = $.Deferred();
    return $("#folders-loader").addClass("spinning").removeClass("hidden"),
    $.post(e, t).done((function(e) {
        if ((e = JSON.parse(e)).hasOwnProperty("alert_type"))
...
function add_batch_payment() {
    $("#modal-wrapper").load(admin_url + "payments/batch_payment_modal", (function() {
        $("#batch-payment-modal").is(":hidden") && $("#batch-payment-modal").modal({
            backdrop: "static",
            show: !0
        }),
        init_selectpicker(),
        ...
        e.on("changed.bs.select", (function() {
            "" !== e.val() ? $(".batch_payment_item").each((function() {
                $(this).data("clientid") == e.val() ? ($(this).find("input, select").prop("disabled", !1),
                $(this).removeClass("hide")) : ($(this).addClass("hide"),
                $(this).find("input, select").prop("disabled", !0))
            }
            )) : $(".batch_payment_item").each((function() {
                $(this).removeClass("hide"),
                $(this).find("input, select").prop("disabled", !1)
            }
            ))
        }
        )),
        ...
        $(".batch_payment_item").each((function() {
            $(this).find('[name^="invoice"]').filter('select[name$="[paymentmode]"],input[name$="[amount]"]').each((function() {
                var e = $(this);
                e.rules("add", {
                    required: function() {
                        var t = !1;
                        return e.closest(".batch_payment_item").find("input, select").filter('select[name$="[paymentmode]"],input[name$="[transactionid]"],input[name$="[amount]"]').each((function() {
                            "" != $(this).val() && (t = !0),
                            $(this).hasClass("selectpicker") && t && (e.prop("required", !0),
...
function configure_ai_editor(e) {
    let t = [{
        type: "menuitem",
        text: app.lang.text_enhancement_make_polite,
        icon: "brightness",
        onAction: function() {
            make_ai_text_enhancement_request(e, "polite")
        }
    }, {
        type: "menuitem",
        ...
        onAction: function() {
            make_ai_text_enhancement_request(e, "formal")
        }
    }, {
        type: "menuitem",
        icon: "emoji",
        ...
        onAction: function() {
            make_ai_text_enhancement_request(e, "friendly")
        }
    }];
    e.ui.registry.addMenuButton("ai", {
        icon: "ai",
        fetch: function(e) {
            e(t)
        }
...
function make_ai_text_enhancement_request(e, t) {
    const a = e.selection.getContent({
        format: "text"
    });
    a.trim() ? $.post(admin_url + "ai/text_enhancement/" + t, {
        text: a
    }).done((function(t) {
        const a = JSON.parse(t);
        a.success && e.selection.setContent(a.message)
    }
    )).catch((function(e) {
        const t = JSON.parse(e.responseText);
        alert_float("danger", t.error ? t.error : app.lang.something_went_wrong)
    }
...
$("body").on("loaded.bs.select change", "select.ajax-search", (function(e) {
    ...
    if ((!Array.isArray(t) || 0 != t.length) && t && !$(this).is(":disabled")) {
        ...
        if (0 === a.find(".ajax-clear-values").length) {
            var i = $(this).attr("id");
            a.addClass("ajax-remove-values-option").find("button.dropdown-toggle").after('<span class="pointer ajax-clear-values" onclick="deselect_ajax_search(this); return false;" data-id="' + i + '"></span>')
        }
    }
}
)),
...
$((function() {
    ...
    $("body").hasClass("has-deprecated-errors") && (e = $("div:contains('A PHP Error was encountered')"),
    t = 0,
    $.each(e, (function() {
        t += $(this).outerHeight(),
    ...
    $("form").has('[data-entities-encode="true"]').on("submit.app.entity", (function(e) {
        $(this).validate().checkForm() && $.each($('[data-entities-encode="true"]'), (function() {
            $(this).hasClass("_entities-processed") || ($(this).val(htmlEntities($(this).val())),
    ...
    add_hotkey("Shift+C", (function() {
        var e = $("#lead-modal")
          , t = $("#task-modal");
        if (e.is(":visible"))
            convert_lead_to_customer(e.find('input[name="leadid"]').val());
        else if (t.is(":visible")) {
            var a = t.find(".tasks-comments");
            a.is(":visible") || a.css("display", "block"),
    ...
    $(document).on("focusin", (function(e) {
        $(e.target).closest(".tox-tinymce, .tox-tinymce-aux, .moxman-window, .tam-assetmanager-root").length && e.stopImmediatePropagation()
    }
    )),
    ...
    tab_group && (a.find("li").not('[role="presentation"]').removeClass("active"),
    a.find('[data-group="' + tab_group + '"]').parents("li").addClass("active")),
    ...
    $(document).on("app.form-validate", (function(e, t) {
        if (!0 === select_picker_validated_event)
            return !0;
        ...
        $(t).on("change", "select.ajax-search, select.selectpicker", (function(e) {
            if ($(this).selectpicker("val") && !$(this).is(":disabled") && void 0 !== $(this).rules() && 1 === Object.keys($(this).rules()).length && $(this).rules().hasOwnProperty("required")) {
                ...
                t.find("#" + $(this).attr("name") + "-error").remove(),
    ...
    if (i.length && (i.parents("li").not(".quick-links").addClass("active"),
    i.prop("aria-expanded", !0),
    i.parents("ul.nav-second-level").prop("aria-expanded", !0),
    i.parents("li").find("a:first-child").prop("aria-expanded", !0)),
    setup_menu.hasClass("display-block")) {
        var n = setup_menu.find('li > a[href="' + location + '"]');
        n.length && (n.parents("li").addClass("active"),
        n.prev("active"),
        n.parents("ul.nav-second-level").prop("aria-expanded", !0),
        n.parents("li").find("a:first-child").prop("aria-expanded", !0))
    }
    side_bar.metisMenu(),
    ...
    $("#search-history").on("click", ".remove-history", (function(e) {
        ...
        requestGet("misc/remove_recent_search/" + t).done((function(e) {
            ...
            a.find("li:eq(" + t + ")").remove(),
            0 == a.find("li").length && a.removeClass("display-block")
        }
        ))
    }
    )),
    $("#search_input").on("click focus", (function() {
        if ("" == $(this).val()) {
            ...
            e.find("li").length > 0 && (e.css("width", $(this).outerWidth() + "px"),
    ...
    $("#search_input").on("keyup paste" + ("safari" == app.browser ? " input" : ""), (function() {
        ...
        if ("" === t)
            return content_wrapper.unhighlight(),
            a.html(""),
            original_top_search_val = "",
            i.html('<i class="fa fa-search"></i>').removeClass("search_remove"),
            void e.addClass("display-block");
        t.length < 2 && -1 === app.user_language.indexOf("chinese") && -1 === app.user_language.indexOf("japanese") || (i.html('<i class="fa fa-remove"></i>').addClass("search_remove"),
        delay((function() {
            t != original_top_search_val && $.post(admin_url + "misc/search", {
                ...
                a.html(e.results),
                content_wrapper.highlight(t),
                original_top_search_val = t,
                set_search_history(e.history)
            }
            ))
        }
        ), 700))
    ...
    if (s && $("#search_input").val(s).trigger("keyup"),
    $("body").on("blur", "#timesheet_duration", (function() {
        var e = $(this)
          , t = $(this).val();
        if ((t = t.replace(/[^0-9:]/gi, "")).indexOf(":") > -1) {
            var a = t.split(":");
            if (0 === a[0].length && (a[0] = "00"),
            a[1] >= 60) {
                var i = Math.floor(parseInt(a[1] / 60));
                a[0] = i + parseInt(a[0]),
                a[1] = a[1] - 60 * i
            }
            1 === a[0].toString().length && (a[0] = "0" + a[0]),
            1 === a[1].toString().length ? a[1] = "0" + a[1] : 0 === a[1].toString().length && (a[1] = "00"),
            t = a[0] + ":" + a[1]
        } else
            1 === t.length && -1 === t.indexOf(":") ? t = "0" + t + ":00" : t.length >= 2 && -1 === t.indexOf(":") && (t += ":00");
        t = "00:00" == t ? "" : t,
        e.val(t)
    }
    )),
    ...
    $("body").on("click", ".delete-reminder", (function() {
        return confirm_delete() && requestGetJSON($(this).attr("href")).done((function(e) {
            alert_float(e.alert_type, e.message),
            $("#task-modal").is(":visible") && _task_append_html(e.taskHtml),
            reload_reminders_tables()
        }
        )),
        !1
    ...
    $("body").on("changed.bs.select", "select.custom-field-multi-select", (function(e) {
        var t = $(this).val();
        $(this).find('option[value=""]').prop("selected", 0 === t.length),
        $(this).selectpicker("refresh")
    }
    )),
    $("body").on("change", ".task-single-inline-field", (function() {
        ...
        $.each(e, (function() {
            ...
            ("startdate" == e && "" !== a || "startdate" != e) && (t[$(this).attr("name")] = a,
            "startdate" != e && "" === a ? i.css("opacity", .5) : i.css("opacity", 1))
        }
        ));
    ...
    $("body").on("change", "#task-modal #checklist_items_templates", (function() {
        ...
        "" !== t && (add_task_checklist_item($("#task-modal").find("[data-task-single-id]").attr("data-task-single-id"), t),
    ...
    $("[data-can-view-own], [data-can-view]").on("change", (function() {
        ...
        view_chk_selector = $(this).parents("tr").find("td input[" + (void 0 !== e && !1 !== e ? "data-can-view" : "data-can-view-own") + "]"),
        1 != view_chk_selector.data("not-applicable") && (view_chk_selector.prop("checked", !1),
        view_chk_selector.prop("disabled", !0 === $(this).prop("checked")))
    }
    )),
    ...
    $("body").on("click", ".task-single-add-timesheet", (function(e) {
        ...
        var t = $("body").find('#task-modal input[name="timesheet_start_time"]')
          ...
          , s = a.val()
          , o = i.val();
        if ("" === n && t.parents(".form-group").addClass("has-error"),
        "" === s && a.parents(".form-group").addClass("has-error"),
        "" === o && i.parents(".form-group").addClass("has-error"),
        "" !== n && "" !== s || "" !== o) {
            var l = {};
            ...
            $.post(admin_url + "tasks/log_time", l).done((function(e) {
                !0 === (e = JSON.parse(e)).success || "true" == e.success ? (init_task_modal(l.timesheet_task_id),
                alert_float("success", e.message),
                setTimeout((function() {
                    reload_tasks_tables()
                }
    ...
    $("body").on("click", ".copy_task_action", (function() {
        ...
        $.post(admin_url + "tasks/copy", e).done((function(e) {
            if (!0 === (e = JSON.parse(e)).success || "true" == e.success) {
                var t = $("#_task_modal");
                t.is(":visible") && t.modal("hide"),
                init_task_modal(e.new_task_id),
                reload_tasks_tables()
            }
            alert_float(e.alert_type, e.message)
        }
    ...
    $("body").on("click", ".new-task-to-milestone", (function(e) {
        ...
        new_task(admin_url + "tasks/task?rel_type=project&rel_id=" + project_id + "&milestone_id=" + t),
    ...
    $("body").on("hide.bs.modal", "#task-modal", (function(e) {
        tinymce.get().forEach((function(t) {
    ...
    $("body").on("hide.bs.modal", "#task-modal", (function(e) {
        var t = $("#task-modal");
        if (t.find(".timesheet-edit").is(":visible") && e.preventDefault(),
        t.find(".add-timesheet").is(":visible")) {
    ...
    $("body").on("change", 'select[name="select-assignees"]', (function() {
        ...
        "" !== e.assignee && (e.taskid = $(this).attr("data-task-id"),
    ...
    $("body").on("change", 'select[name="select-followers"]', (function() {
        ...
        "" !== e.follower && (e.taskid = $(this).attr("data-task-id"),
        $("body").append('<div class="dt-loader"></div>'),
    ...
    $("body").on("click", "[lead-edit]", (function(e) {
        ...
        if ($("body .lead-view").toggleClass("hide"),
        t.toggleClass("hide"),
        !t.hasClass("hide")) {
            var a = $("#lead-modal").find("#address")
              , i = a[0].scrollHeight;
            a.is("textarea") && (a.height(0).height(i - 15),
            a.css("padding-top", "9px"))
        }
    }
    )),
    $("body").on("click", ".new-lead-from-status", (function(e) {
        ...
        init_lead_modal_data(void 0, admin_url + "leads/lead?status_id=" + t),
        $('body [data-toggle="popover"]').popover("hide")
    }
    )),
    $("body").on("change", "input.include_leads_custom_fields", (function() {
        ...
        2 == e ? $("#merge_db_field_" + t).removeClass("hide") : $("#merge_db_field_" + t).addClass("hide"),
        3 == e ? $("#merge_db_contact_field_" + t) : $("#merge_db_contact_field_" + t).addClass("hide")
    }
    )),
    calendar_selector.length > 0) {
        ...
        var o = {
            ...
            eventSources: [function(e, t, a) {
                ...
                $.getJSON(admin_url + "utilities/get_calendar_data", $.extend({}, i, {
                    start: e.startStr,
                    end: e.endStr
                })).then((function(e) {
                    t(e.map((function(e) {
            ...
            eventDidMount: function(e) {
                ...
                e.event.extendedProps.url || t.on("click", (function() {
            ...
            dateClick: function(e) {
                ...
                return $("input[name='start'].datetimepicker").val(t),
        ...
        1 == app.user_is_staff_member && ("" !== app.options.google_api && (o.googleCalendarApiKey = app.options.google_api),
        "" !== app.calendarIDs && (app.calendarIDs = JSON.parse(app.calendarIDs),
        0 != app.calendarIDs.length)))
            if ("" !== app.options.google_api)
                for (var l = 0; l < app.calendarIDs.length; l++) {
                    var d = {};
                    d.googleCalendarId = app.calendarIDs[l],
                    o.eventSources.push(d)
                }
            else
        ...
        r.render(),
        get_url_param("new_event") && ($("input[name='start'].datetimepicker").val(get_url_param("date")),
        $("#newEventModal").modal("show"))
    }
    $("body").on("change", 'select[name="tax"]', (function() {
        var e = $("body").find('select[name="tax2"]')
          , t = $(this);
        "" !== t.val() ? e.prop("disabled", !1) : (e.prop("disabled", !0),
        "" !== e.val() && (t.selectpicker("val", e.val()),
        e.val(""),
    ...
    $("body").on("click", "#invoice_create_credit_note", (function(e) {
        ...
        t.modal("show"),
        t.find("#confirm-invoice-credit-note").attr("href", $(this).attr("href")),
        e.preventDefault()
    }
    )),
    $("body").on("change blur", ".apply-credits-to-invoice .apply-credits-field", (function() {
        ...
        $.each(t, (function() {
            if (!0 === $(this).valid()) {
                var e = $(this).val();
                e = parseFloat(e),
                isNaN(e) ? $(this).val(0) : a += e
            }
        }
        )),
        e.find("#credits-alert").remove(),
        e.find(".amount-to-credit").html(format_money(a)),
        i < a ? ($(".credits-table").before($("<div/>", {
            id: "credits-alert",
            class: "alert alert-danger"
        }).html(app.lang.credit_amount_bigger_then_credit_note_remaining_credits)),
        e.find('[type="submit"]').prop("disabled", !0)) : (e.find(".credit-note-balance-due").html(format_money(i - a)),
        e.find('[type="submit"]').prop("disabled", !1))
    }
    )),
    $("body").on("change", "#main-optional", (function(e) {
        e.target.checked ? $("#main-optional-choosen").parent().css("display", "block") : $("#main-optional-choosen").parent().css("display", "none")
    }
    )),
    $("body").on("change", ".optional-item-checkbox", (function(e) {
        e.target.checked ? $(e.target).parent().next().css("display", "block") : $(e.target).parent().next().css("display", "none"),
        calculate_total()
    }
    )),
    ...
    $("body").on("change blur", ".apply-credits-from-invoice .apply-credits-field", (function() {
        ...
        e.find("#credits-alert").remove(),
        e.find(".amount-to-credit").html(format_money(a)),
        a > i ? ($(".credits-table").before($("<div/>", {
            id: "credits-alert",
            class: "alert alert-danger"
        }).html(app.lang.credit_amount_bigger_then_invoice_balance)),
        e.find('[type="submit"]').prop("disabled", !0)) : (e.find(".invoice-balance-due").html(format_money(i - a)),
        e.find('[type="submit"]').prop("disabled", !1))
    }
    )),
    $('input[name="notify_type"]').on("change", (function() {
        var e = $('input[name="notify_type"]:checked').val()
          ...
          , a = $("#role_notify");
        "specific_staff" == e ? (t.removeClass("hide"),
        a.addClass("hide")) : "roles" == e ? (t.addClass("hide"),
        a.removeClass("hide")) : "assigned" == e && (t.addClass("hide"),
        a.addClass("hide"))
    }
    )),
    ...
    $("body").on("click", '#lead-modal a[data-toggle="tab"]', (function() {
        "#tab_lead_profile" == this.hash || "#attachments" == this.hash || "#lead_notes" == this.hash || "#gdpr" == this.hash || "#lead_activity" == this.hash ? window.location.hash = this.hash : history.pushState("", document.title, window.location.pathname + window.location.search),
        $(document).resize()
    }
    )),
    ...
    if ((table_leads = $("table.table-leads")).length) {
        ...
        $.each(c, (function(e, t) {
            $("select" + t).on("change", (function() {
                $("[name='view_status[]']").prop("disabled", "lost" == $(this).val() || "junk" == $(this).val()).selectpicker("refresh"),
    ...
    $(".bulk_actions").on("change", 'input[name="mass_delete"]', (function() {
        var e = $("#bulk_change");
        !0 === $(this).prop("checked") ? (e.find("select").selectpicker("val", ""),
        e.addClass("hide"),
        $(".mass_delete_separator, merge_tickets_checkbox").addClass("hide"),
        $("#merge_tickets").prop("checked", !1)) : (e.removeClass("hide"),
    ...
    $("body").on("change loaded.bs.select", "#item_select", (function() {
        ...
        $(".items-wrapper .bootstrap-select").css("max-width", e.width() + "px"),
    ...
    $("body").on("hidden.bs.modal", "#__todo", (function() {
        var e = $("#__todo");
        e.find('input[name="todoid"]').val(""),
        e.find('textarea[name="description"]').val(""),
        e.find(".add-title").addClass("hide"),
        e.find(".edit-title").addClass("hide")
    }
    )),
    $("body").on("shown.bs.modal", "#__todo", (function() {
        var e = $("#__todo");
        e.find('textarea[name="description"]').focus(),
        "" !== e.find('input[name="todoid"]').val() ? (e.find(".add-title").addClass("hide"),
        e.find(".edit-title").removeClass("hide")) : (e.find(".add-title").removeClass("hide"),
        e.find(".edit-title").addClass("hide"))
    }
    )),
    $("#top_search_button button").on("click", (function() {
        var e = $("#search_input");
        $(this).hasClass("search_remove") && ($(this).html('<i class="fa fa-search"></i>').removeClass("search_remove"),
        original_top_search_val = "",
        $("#search_results").html(""),
        e.val("")),
        e.focus()
    ...
    $(".btn-import-submit").on("click", (function() {
        $(this).hasClass("simulate") && $("#import_form").append(hidden_input("simulate", !0)),
        $("#import_form").submit()
    }
    )),
    ...
    $("body").on("change", '[name="repeat_every"], [name="recurring"]', (function() {
        ...
        "" !== e && 0 != e ? $("body").find("#cycles_wrapper").removeClass("hide") : ($("body").find("#cycles_wrapper").addClass("hide"),
        $("body").find("#cycles_wrapper #cycles").val(0),
        $("#unlimited_cycles").prop("checked", !0).change())
    }
    )),
    ...
    $(".close-customizer").on("click", (function(e) {
        e.preventDefault(),
        setup_menu.addClass("true" == isRTL ? "fadeOutRight" : "fadeOutLeft"),
    ...
    $("body").on("click", ".cpicker", (function() {
        ...
        $(this).hasClass("kanban-cpicker") ? ($(this).parents(".panel-heading").css("background", e),
        $(this).parents(".panel-heading").css("border", "1px solid " + e)) : $(this).hasClass("calendar-cpicker") && $("body").find('._event input[name="color"]').val(e)
    }
    )),
    ...
    $("body").on("click" + ("ontouchstart"in window ? " touchstart" : ""), ".notifications a.notification-top, .notification_link", (function(e) {
        e.preventDefault();
        var t, a = $(this), i = a.hasClass("notification_link") ? a.data("link") : e.currentTarget.href, n = i.split("#"), s = !0;
        if (n[1] && n[1].indexOf("=") > -1)
            if (s = !1,
            t = n[1].split("=")[1],
            n[1].indexOf("postid") > -1)
                postid = t,
                $(window).width() > 769 ? $(".open_newsfeed.desktop").click() : $(".open_newsfeed.mobile").click();
                ...
                n[1].indexOf("leadid") > -1 ? init_lead(t) : n[1].indexOf("eventid") > -1 && view_event(t);
    ...
    $(".notifications-wrapper").on("show.bs.dropdown", (function() {
        notifications_wrapper.find(".notifications").attr("data-total-unread") > 0 && $.post(admin_url + "misc/set_notifications_read").done((function(e) {
            !0 !== (e = JSON.parse(e)).success && "true" != e.success || (document.title = doc_initial_title,
    ...
    (table_activity_log = $("table.table-activity-log")).length) {
        var u = [];
        u.activity_log_date = '[name="activity_log_date"]',
        initDataTable(table_activity_log, window.location.href, "undefined", "undefined", u, [1, "desc"])
    }
    if (table_invoices = $("table.table-invoices"),
    table_estimates = $("table.table-estimates"),
    table_invoices.length > 0 || table_estimates.length > 0) {
        var f = {}
        ...
        table_invoices.length && initDataTable(table_invoices, admin_url + "invoices/table" + ($("body").hasClass("recurring") ? "?recurring=1" : ""), "undefined", "undefined", f, $("body").hasClass("recurring") ? [table_invoices.find("th.next-recurring-date").index(), "asc"] : [[3, "desc"], [0, "desc"]]),
        table_estimates.length && initDataTable(table_estimates, admin_url + "estimates/table", "undefined", "undefined", f, [[3, "desc"], [0, "desc"]])
    }
    ...
    $("body").on("click", ".open_newsfeed, .close_newsfeed", (function(e) {
        e.preventDefault(),
        void 0 === $(this).data("close") ? requestGet("newsfeed/get_data").done((function(e) {
            $("#newsfeed").html(e),
        ...
        )) : !0 === $(this).data("close") && (newsFeedDropzone.destroy(),
        $("#newsfeed").html(""),
    ...
    $("#modal_post_likes").on("show.bs.modal", (function(e) {
        ...
        var t = $(e.relatedTarget)
          , a = $(t).data("postid");
        post_likes_total_pages = $(t).data("total-pages"),
        $(".load_more_post_likes").attr("data-postid", a),
        load_post_likes(a)
    }
    )),
    $("#modal_post_comment_likes").on("show.bs.modal", (function(e) {
        ...
        var t = $(e.relatedTarget)
          , a = $(t).data("commentid");
        comment_likes_total_pages = $(t).data("total-pages"),
        $(".load_more_post_comment_likes").attr("data-commentid", a),
        load_comment_likes(a)
    }
    )),
    ...
    $("body").on("submit", "._transaction_form", (function() {
        ...
        var e = $(this).find("table.items")
          , t = e.find(".main");
        return t.find('[name="description"]').length && t.find('[name="description"]').val().trim().length > 0 && t.find('[name="rate"]').val().trim().length > 0 ? (e.before('<div class="alert alert-warning mbot20" id="items-warning">' + app.lang.item_forgotten_in_preview + '<i class="fa fa-angle-double-down pointer pull-right fa-2x" style="margin-top:-4px;" onclick="add_item_to_table(\'undefined\',\'undefined\',undefined); return false;"></i></div>'),
        $("html,body").animate({
            scrollTop: $("#items-warning").offset().top
        }),
        !1) : e.length && 0 === e.find(".item").length ? (e.before('<div class="alert alert-warning mbot20" id="items-warning">' + app.lang.no_items_warning + "</div>"),
        $("html,body").animate({
            scrollTop: $("#items-warning").offset().top
        }),
        !1) : (reorder_items(),
    ...
    $("body").on("submit", "#sales-notes", (function() {
        ...
        if ("" !== e.find('textarea[name="description"]').val())
            return $.post(e.attr("action"), $(e).serialize()).done((function(t) {
                e.find('textarea[name="description"]').val(""),
                e.hasClass("estimate-notes-form") ? get_sales_notes(t, "estimates") : e.hasClass("invoice-notes-form") ? get_sales_notes(t, "invoices") : e.hasClass("proposal-notes-form") ? get_sales_notes(t, "proposals") : e.hasClass("contract-notes-form") && get_sales_notes(t, "contracts")
            }
            )),
            !1
    }
    ...
    $("body").on("change", 'div.invoice input[name="date"], div.estimate input[name="date"], div.proposal input[name="date"]', (function() {
        var e = $(this).val();
        if (do_prefix_year(e),
        !($('input[name="isedit"]').length > 0)) {
            var t = "duedate"
              , a = admin_url + "invoices/get_due_date";
            $("body").find("div.estimate").length > 0 ? (a = admin_url + "estimates/get_due_date",
            t = "expirydate") : $("body").find("div.proposal").length > 0 && (a = admin_url + "proposals/get_due_date",
            t = "open_till"),
            "" === e && $('input[name="' + t + '"]').val(""),
            "" !== e && $.post(a, {
                date: e
    ...
    $("#sales-upload").length > 0 && new Dropzone("#sales-upload",appCreateDropzoneOptions({
        sending: function(e, t, a) {
            a.append("rel_id", $("body").find('input[name="_attachment_sale_id"]').val()),
            a.append("type", $("body").find('input[name="_attachment_sale_type"]').val())
        },
        success: function(e, t) {
            t = JSON.parse(t);
            var a, i = $("body").find('input[name="_attachment_sale_type"]').val();
            a = "delete_" + i + "_attachment",
            "estimate" == i ? $("body").hasClass("estimates-pipeline") ? estimate_pipeline_open(t.rel_id) : init_estimate(t.rel_id) : "proposal" == i ? $("body").hasClass("proposals-pipeline") ? proposal_pipeline_open(t.rel_id) : init_proposal(t.rel_id) : "function" == typeof window["init_" + i] && window["init_" + i](t.rel_id);
            var n = "";
            !0 !== t.success && "true" != t.success || (n += '<div class="display-block sales-attach-file-preview" data-attachment-id="' + t.attachment_id + '">',
    ...
    $("body").on("click", ".discount-total-type", (function(e) {
        ...
        $(this).hasClass("discount-type-percent") ? ($(".input-discount-fixed").addClass("hide").val(0),
        $(".input-discount-percent").removeClass("hide")) : ($(".input-discount-fixed").removeClass("hide"),
    ...
    $("body").on("change", ".f_client_id #clientid", (function() {
        var e = $(this).val()
          ...
          , a = t.html("").clone()
          , i = $(".projects-wrapper");
        if (t.selectpicker("destroy").remove(),
        t = a,
        $("#project_ajax_search_wrapper").append(a),
    ...
    $("body").on("click", "#get_shipping_from_customer_profile", (function(e) {
        ...
        !1 === t.prop("checked") && (t.prop("checked", !0),
    ...
    "undefined" != typeof accounting && (accounting.settings.currency.precision = app.options.decimal_places,
    ...
    $("body").on("change", 'input[name="invoices_to_merge[]"]', (function() {
        ...
        !0 === e ? requestGetJSON("invoices/get_merge_data/" + t).done((function(e) {
            $.each(e.items, (function(e, a) {
                "" !== a.rel_type && ("task" == a.rel_type ? $('input[name="task_id"]').val(a.item_related_formatted_for_input) : "expense" == a.rel_type && $('input[name="expense_id"]').val(a.item_related_formatted_for_input)),
    ...
    $("body").on("change", 'input[name="bill_expenses[]"]', (function() {
        ...
        !0 === e ? requestGetJSON("invoices/get_bill_expense_data/" + t).done((function(e) {
            $('input[name="expense_id"]').val(t),
            add_item_to_table(e, "undefined", "undefined", t)
        }
        )) : ($("body").find('[data-bill-expense="' + t + '"]').remove(),
        $("body").find('#billed-expenses input[value="' + t + '"]').remove())
    }
    )),
    $("body").on("change", ".invoice_inc_expense_additional_info input", (function() {
        var e, t = $(this).attr("data-content"), a = $("[data-bill-expense=" + $(this).attr("data-id") + "] .item_long_description");
        current_desc_val = a.val(),
        current_desc_val = current_desc_val.trim(),
        "" !== t && (!0 === $(this).prop("checked") ? (e = current_desc_val + "\n" + t,
        a.val(e.trim())) : (a.val(current_desc_val.replace("\n" + t, "")),
        a.val(current_desc_val.replace(t, ""))))
    }
    ))
}
)),
$(document).keyup((function(e) {
    27 == e.keyCode && ($(".popup-wrapper").is(":visible") && $(".popup-wrapper").find(".system-popup-close").click(),
    $("#search-history").is(":visible") && $("#search-history").removeClass("display-block"))
}
)),
$("#newsfeed").scroll((function(e) {
    var t = $(e.currentTarget);
    t[0].scrollHeight - t.scrollTop() == t.outerHeight() && load_newsfeed(),

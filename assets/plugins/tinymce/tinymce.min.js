...
!function() {
    ...
    const xt = () => wt()
      ...
      , rn = e => X(e.dom.attributes, ( (e, t) => (e[t.name] = t.value,
    e)), {})
      , sn = (e, t) => {
        const n = en(e, t);
      ...
      , dn = (e, t) => ( (e, t, n) => {
        ...
        return Jt(e, t, o.join(" ")),
        !0
    }
    )(e, "class", t)
      , cn = (e, t) => ( (e, t, n) => {
        const o = Y(sn(e, t), (e => e !== n));
        return o.length > 0 ? Jt(e, t, o.join(" ")) : on(e, t),
        !1
    }
    )(e, "class", t)
      , un = (e, t) => {
      ...
      , fn = (e, t) => {
        an(e) ? e.dom.classList.remove(t) : cn(e, t),
        mn(e)
    }
    ...
    const Qn = (e, t, n) => {
      ...
      , oo = (e, t=!1) => {
        return Gn(e) ? e.dom.isContentEditable : (n = e,
        no(n, "[contenteditable]")).fold(N(t), (e => "true" === ro(e)));
        var n
    }
    ...
    !1)
      ...
      , ea = {
        ...
        ,
        decode: e => e.replace(Vs, ( (e, t) => t ? (t = "x" === t.charAt(0).toLowerCase() ? parseInt(t.substr(1), 16) : parseInt(t, 10)) > 65535 ? (t -= 65536,
        String.fromCharCode(55296 + (t >> 10), 56320 + (1023 & t))) : Ws[t] || String.fromCharCode(t) : Ys[e] || Xs[e] || (e => {
            const t = bn("div").dom;
      ...
      , ua = (e={}) => {
        ...
        const s = {}
          ...
          , d = (e => {
            const {globalAttributes: t, phrasingContent: n, flowContent: o} = (e => {
                ...
                "html4" !== e && (t += " contenteditable contextmenu draggable dropzone hidden spellcheck translate",
                n += " article aside details dialog figure main header footer hgroup section nav a ins del canvas map",
                o += " audio canvas command datalist mark meter output picture progress time wbr video ruby bdi keygen svg"),
                "html5-strict" !== e && (t += " xml:lang",
            ...
            a("body", "onafterprint onbeforeprint onbeforeunload onblur onerror onfocus onhashchange onload onmessage onoffline ononline onpagehide onpageshow onpopstate onresize onscroll onstorage onunload", o),
            a("dd div", "", o),
            ...
            a("button", "disabled form formaction formenctype formmethod formnovalidate formtarget name type value", "html4" === e ? o : n),
            ...
            a("video", "src crossorigin poster preload autoplay mediagroup loop muted controls width height buffered", [o, "track source"].join(" ")),
            a("audio", "src crossorigin preload autoplay mediagroup loop muted controls buffered volume", [o, "track source"].join(" ")),
            ...
            s("svg", "id tabindex lang xml:space class style x y width height viewBox preserveAspectRatio zoomAndPan transform".split(" "), [])),
                            ...
                            V(ta(e, "|"), (e => {
                                ...
                                if (a) {
                                    const e = {}
                                      ...
                                      , l = a[3]
                                      , d = a[4];
                                    if ("!" === n && (t.attributesRequired = t.attributesRequired || [],
                                    t.attributesRequired.push(i),
                                    e.required = !0),
                                    "-" === n)
                                        return delete r[i],
                                        void s.splice(Pt.inArray(s, i), 1);
                                    if (l && ("=" === l ? (t.attributesDefault = t.attributesDefault || [],
                                    t.attributesDefault.push({
                                        name: i,
                                        value: d
                                    }),
                                    e.defaultValue = d) : "~" === l ? (t.attributesForced = t.attributesForced || [],
                                    t.attributesForced.push({
                                        name: i,
                                        value: d
                                    }),
                                    e.forcedValue = d) : "<" === l && (e.validValues = Pt.makeMap(d, "?"))),
                                    o.test(i)) {
                                        const n = e;
        ...
        ;
        e.valid_elements ? (R(e.valid_elements),
        sa(d, ( (e, t) => {
            o[t] = e.children
        }
        ))) : (sa(d, ( (e, t) => {
      ...
      , va = e => {
        if ("transparent" === e)
            return I.some(ha(0, 0, 0, 0));
        const t = ga.exec(e);
        if (null !== t)
            return I.some(ba(t[1], t[2], t[3], "1"));
        const n = pa.exec(e);
        ...
        const c = {
            parse: t => {
                ...
                const d = e.url_converter
                  ...
                  , p = e => (i = !0,
                s[e])
                  , h = (e, t) => (i && (e = e.replace(/\uFEFF[0-9]/g, (e => s[e]))),
                t || (e = e.replace(/\\([\'\";:])/g, "$1")),
                e)
                ...
                if (t) {
                    ...
                    for (t = (t = t.replace(/[\u0000-\u001F]/g, "")).replace(/\\[\"\';:\uFEFF]/g, p).replace(/\"[^\"]+\"|\'[^\']+\'/g, (e => e.replace(/[;:]/g, p))); s = o.exec(t); ) {
                        ...
                        if (t && d) {
                            ...
                            if (!e.allow_script_urls && ("behavior" === t || /expression\s*\(|\/\*|\*\//.test(d)))
                                continue;
                            "font-weight" === t && "700" === d ? d = "bold" : "color" !== t && "background-color" !== t || (d = d.toLowerCase()),
                            m(e.force_hex_color) && "off" !== e.force_hex_color && va(d).each((t => {
                    ...
                    w = "border-style",
                    x = "border-color",
                    g(C = "border-width") && g(w) && g(x) && (a.border = a[C] + " " + a[w] + " " + a[x],
                    delete a[C],
                    delete a[w],
                    delete a[x]),
      ...
      , Aa = (e, t, n) => {
        ...
        ;
        "complete" === o.readyState || "interactive" === o.readyState && o.body ? s() : Sa(e, "DOMContentLoaded", s),
    ...
    class Ta {
        ...
        bind(e, t, n, o) {
            ...
            for (; c--; ) {
                ...
                r.domLoaded && "ready" === t && "complete" === e.readyState ? n.call(o, Ra({
                    type: t
      ...
      , za = (e, t={}) => {
        ...
        const a = Is.forElement(yn(e), {
          ...
          , k = (e, t, n) => {
            const o = f(e);
            var r;
            if (!y(o) && (Vo(o) || qo(r = o) && "http://www.w3.org/2000/svg" === r.namespaceURI))
                return n ? co(yn(o), Ma(t)) : ("float" === (t = t.replace(/-(\D)/g, ( (e, t) => t.toUpperCase()))) && (t = "cssFloat"),
            ...
            isEmpty: (e, t, n) => {
                ...
                if (r) {
                    ...
                    do {
                        ...
                        if (or(d))
                            return !1;
                        if (er(d) && !ss(d.data) && (!(null == n ? void 0 : n.includeZwsp) || !as(d.data)))
                            return !1;
                        if (er(d) && d.parentNode && a[d.parentNode.nodeName] && ss(d.data))
                            return !1;
                        d = s.next()
                    } while (d)
                }
    ...
    class Ha {
        ...
        loadScripts(e) {
            const t = this
              ...
              , r = e => Promise.allSettled(q(e, (e => 2 === t.states[e] ? (n("resolve", e),
      ...
      , Ya = () => {
        ...
        return {
            ...
            load: (e, o) => {
                ...
                0 !== s.indexOf("/") && -1 === s.indexOf("://") && (s = Ya.baseURL + "/" + s),
    ...
    e)
      ...
      , $i = e => {
        ...
        return n = o.length > 0 ? vi(o[0]) : vi(e.getBoundingClientRect()),
        !zi(e) && Li(e) && Hi(n) ? (e => {
        ...
        const o = () => (n || (n = (e => {
            const t = []
              ...
              , o = (e, t) => {
                ...
                if (t < e.data.length) {
                    if (Ni(e.data[t]))
                        return;
                    if (Ni(e.data[t - 1]) && (o.setStart(e, t),
                    o.setEnd(e, t + 1),
                    !ji(o)))
            ...
            if (Ri(r))
                if (e.isAtEnd()) {
                    ...
                    Bi(i) && !Li(i) && (Ti(i) || Ti(a) || !Bi(a)) && n(qi($i(i), !1)),
                    Bi(a) && n(qi($i(a), !0))
                }
            return t
        }
    ...
    Vi.isAbove = (e, t) => Mt(le(t.getClientRects()), de(e.getClientRects()), wi).getOr(!1),
    Vi.isBelow = (e, t) => Mt(de(t.getClientRects()), le(e.getClientRects()), xi).getOr(!1),
    ...
    const Wi = (e, t) => {
      ...
      , Ji = e => e ? Oe(e.childNodes, ( (e, t) => (Gi(t) && "BR" !== t.nodeName ? e = e.concat(Ji(t)) : e.push(t),
    e)), []) : []
      , Zi = e => t => e === t
      , el = e => (Yi(e) ? "text()" : e.nodeName.toLowerCase()) + "[" + (e => {
        ...
        n = Be(t, Zi(e), e),
        t = t.slice(0, n + 1);
        const o = Oe(t, ( (e, n, o) => (Yi(n) && Yi(t[o - 1]) && e++,
        e)), 0);
        return t = Te(t, Ko([e.nodeName])),
        n = Be(t, Zi(e), e),
        n - o
    }
    )(e) + "]"
      ...
      , nl = (e, t) => {
        ...
        const n = t.split(",")
          ...
          , s = Oe(o, ( (e, t) => {
            ...
            ( (e, t, n) => {
                let o = Ji(e);
                return o = Te(o, ( (e, t) => !Yi(e) || !Yi(o[t - 1]))),
                o = Te(o, Ko([t])),
                o[n]
            }
        ...
        return ( (e, t) => {
            ...
            return Yi(e) && t > e.data.length && (t = e.data.length),
            Vi(e, t)
        }
        )(s, parseInt(r, 10))
    }
      ...
      , rl = (e, t, n, o, r) => {
        ...
        if (er(s))
            i.push(n ? ( (e, t, n) => {
                ...
                for (let n = t.previousSibling; n && er(n); n = n.previousSibling)
                    o += e(n.data).length;
                return o
            }
            )(t, s, a) : a);
      ...
      , sl = (e, t, n) => {
        let o = 0;
        return Pt.each(e.select(t), (e => "all" === e.getAttribute("data-mce-bogus") ? void 0 : e !== n && void o++)),
        o
    }
      , al = (e, t) => {
    ...
    const bl = e => "inline-command" === e.type || "inline-format" === e.type
      ...
      , xl = e => {
        ...
        return V(t.errors, (e => console.error(e.message, e.pattern))),
        t.values
    }
      , El = xt().deviceType
      , _l = El.isTouch()
    ...
    t)
      , Nc = (e, t) => Vi.isTextPosition(t) ? ( (e, t) => xc(e) && t.container() === e ? ( (e, t) => {
        ...
        return (n.text + o.text).length > 0 ? (kc(e),
        Vi(e, t.offset() - n.count)) : t
    }
        ...
        return {
            show: (e, c) => {
                ...
                if (!n(c))
                    ...
                    Lc(a.nextSibling) ? (u.setStart(a, 0),
    ...
    const uu = dr
      ...
      , yu = (e, t) => {
        ...
        if (Kc(e)) {
            if (pu(t.nextSibling) && !mu(t.nextSibling))
                return Vi.after(t);
            if (mu(t))
                return Vi(t, t.data.length)
        }
      ...
      , Cu = (e, t, n) => {
        ...
        if (mu(i)) {
            ...
            if (Kc(e) && l > 0 && (r = vu(i, l - 1),
            pu(r)))
                return !hu(r) && (s = Gc(r, e, bu, r),
                s) ? mu(s) ? Vi(s, s.data.length) : Vi.after(s) : mu(r) ? Vi(r, r.data.length) : Vi.before(r);
            if (Wc(e) && l < i.childNodes.length && (r = vu(i, l),
            pu(r)))
                return gu(r) ? ( (e, t) => {
                    const n = t.nextSibling;
                    return n && pu(n) ? mu(n) ? Vi(n, 0) : Vi.before(n) : Cu(cu.Forwards, Vi.after(t), e)
                }
                )(n, r) : !hu(r) && (s = Gc(r, e, bu, r),
                s) ? mu(s) ? Vi(s, 0) : Vi.before(s) : mu(r) ? Vi(r, 0) : Vi.after(r);
            o = r || a.getNode()
        }
        if (o && (Wc(e) && a.isAtEnd() || Kc(e) && a.isAtStart()) && (o = Gc(o, e, M, n, !0),
        bu(o, n)))
            return yu(e, o);
        r = o ? Gc(o, e, bu, n) : o;
        const d = Pe(Y(( (e, t) => {
        ...
        return !d || r && d.contains(r) ? r ? yu(e, r) : null : (a = Wc(e) ? Vi.after(d) : Vi.before(d),
        a)
    }
      , wu = e => ({
      ...
      , Su = (e, t, n) => ku(e, t, n).bind((o => Qc(n, o, t) && ( (e, t, n) => {
        return e ? !_u(t, n) && (o = t,
        !(!Vi.isTextPosition(o) && ar(o.getNode()))) && Eu(t) && xu(n) : !_u(n, t) && xu(t) && Eu(n);
        var o
    }
      ...
      , Uu = (e, t) => (qo(t) && e.isBlock(t) && !t.innerHTML && (t.innerHTML = '<br data-mce-bogus="1" />'),
    t)
      , zu = (e, t) => Bu(e).fold(L, (e => (t.setStart(e.container(), e.offset()),
    ...
    0))
      ...
      , qu = (e, t, n) => {
        ...
        if (o && r) {
            ...
            i = 1) : $u(o.nextSibling) ? (a = o.nextSibling,
            i = 0) : $u(o.previousSibling) ? (a = o.previousSibling,
            i = o.previousSibling.data.length) : (a = r,
            i = e.nodeIndex(o) + 1) : (a = r,
            i = e.nodeIndex(o)) : s ? o.hasChildNodes() ? (a = o.firstChild,
            i = 1) : $u(o.previousSibling) ? (a = o.previousSibling,
            i = o.previousSibling.data.length) : (a = r,
            i = e.nodeIndex(o)) : (a = r,
            i = e.nodeIndex(o)),
            !s) {
                ...
                if ((e => Ee(e, "id"))(t))
                    return ( (e, t) => {
                        ...
                        return Mt(n, o.or(n), ( (n, o) => {
                            const r = e.createRng();
                            return r.setStart(Uu(e, n.container()), n.offset()),
    ...
    const Xu = e => "" !== e && -1 !== " \f\n\r\t\v".indexOf(e)
      ...
      , mm = (e, t) => {
        ...
        if (!( (e, t) => {
            ...
            if (a < i.length) {
                ...
                d = new jo(t,null !== (o = e.getParent(t, e.isBlock)) && void 0 !== o ? o : l),
                d.next(!0)
            }
      ...
      , vm = (e, t) => w(e) ? e(t) : (C(t) && (e = e.replace(/%(\w+)/g, ( (e, n) => t[n] || e))),
    e)
      , ym = (e, t) => (t = t || "",
    e = "" + ((e = e || "").nodeName || e),
    t = "" + (t.nodeName || t),
    e.toLowerCase() === t.toLowerCase())
      , Cm = (e, t) => {
        ...
        {
            let n = String(e);
            return "color" !== t && "backgroundColor" !== t || (n = Ca(n)),
      ...
      , xm = (e, t) => {
        let n;
        return e.getParent(t, (t => !!qo(t) && (n = e.getStyle(t, "text-decoration"),
        !!n && "none" !== n))),
        n
    }
      ...
      , Am = e => (e => {
        ...
        let n = e;
        for (; n; ) {
            if (er(n) && n.data !== Br || n.childNodes.length > 1)
                return [];
            qo(n) && t.push(n),
            n = n.firstChild
        }
      ...
      , Um = (e, t, n, o, r, s) => {
        ...
        const i = e.getParent(n, e.isBlock) || t
          , l = (t, n, o) => {
            ...
            return I.from(l(t, n, ( (e, t) => Om(e.parentNode) ? -1 : (a = e,
            o(r, e, t))), i))
        }
        ;
      ...
      , zm = (e, t, n, o, r) => {
        ...
        for (let o = 0; o < a.length; o++)
            for (let r = 0; r < t.length; r++) {
                const s = t[r];
                if ((!C(s.collapsed) || s.collapsed === n.collapsed) && Sm(s) && e.is(a[o], s.selector))
                    return a[o]
            }
        return o
    }
      ...
      , $m = (e, t, n, o, r) => {
        ...
        const a = r ? "previousSibling" : "nextSibling"
          , i = e.getRoot();
        if (er(n) && !Pm(n) && (r ? o > 0 : o < n.data.length))
            return n;
        for (; s; ) {
            ...
            for (let t = s[a]; t; t = t[a]) {
                ...
                if (!Om(t) && (!ar(l = t) || !l.getAttribute("data-mce-bogus") || l.nextSibling) && !Pm(t, n))
                    return s
            }
      ...
      , Vm = (e, t, n, o=!1) => {
        ...
        const l = n[0];
        return qo(r) && r.hasChildNodes() && (r = ki(r, s),
        er(r) && (s = 0)),
        qo(a) && a.hasChildNodes() && (a = ki(a, t.collapsed ? i : i - 1),
        er(a) && (i = a.data.length)),
        r = Lm(e, r),
        a = Lm(e, a),
        qm(r) && (r = Om(r) ? r : r.parentNode,
        r = t.collapsed ? r.previousSibling || r : r.nextSibling || r,
        er(r) && (s = t.collapsed ? r.length : 0)),
        qm(a) && (a = Om(a) ? a : a.parentNode,
        a = t.collapsed ? a.nextSibling || a : a.previousSibling || a,
        er(a) && (i = t.collapsed ? 0 : a.length)),
        t.collapsed && (Um(e, e.getRoot(), r, s, !0, o).each(( ({container: e, offset: t}) => {
            r = e,
            s = t
        }
        )),
        ...
        (Nm(l) || l.block_expand) && (Nm(l) && er(r) && 0 !== s || (r = $m(e, n, r, s, !0)),
        Nm(l) && er(a) && i !== a.data.length || (a = $m(e, n, a, i, !1))),
        Rm(l) && (r = zm(e, n, t, r, "previousSibling"),
        a = zm(e, n, t, a, "nextSibling")),
        (km(l) || Sm(l)) && (r = jm(e, n, r, "previousSibling"),
        a = jm(e, n, a, "nextSibling"),
        km(l) && (e.isBlock(r) || (r = $m(e, n, r, s, !0)),
        e.isBlock(a) || (a = $m(e, n, a, i, !1)))),
        qo(r) && r.parentNode && (s = e.nodeIndex(r),
        r = r.parentNode),
        qo(a) && a.parentNode && (i = e.nodeIndex(a) + 1,
        a = a.parentNode),
        {
            startContainer: r,
            startOffset: s,
      ...
      , Wm = (e, t, n) => {
        ...
        const r = t.startOffset
          ...
          , l = e => {
            ...
            return 0 === a && e.length > 0 && n === i && er(n) && e.splice(e.length - 1, 1),
            e
        }
          , d = (e, t, n) => {
            const o = [];
      ...
      , mf = (e, t) => {
        ...
        const x = e => C(e) && (ir(e) || n.is(e, "figure.image"))
          ...
          , A = e => {
            ...
            b = b < 5 ? 5 : b,
            v = v < 5 ? 5 : v,
            c = (x(a) || E(a)) && !1 !== ud(t) ? !af.modifierPressed(e) : af.modifierPressed(e),
            c && (df(o) > df(r) ? (v = cf(b * p),
            b = cf(v / p)) : (b = cf(v / p),
            v = cf(b * p))),
            R(i, b, v),
            C = d.startPos.x + o,
    ...
    : I.none
      ...
      , Df = (e, t, n, o, r) => {
        ...
        if (o && ar(r) && t && e.isEmpty(c))
            return I.some(Vi(i, e.nodeIndex(r)));
        const u = new jo(r,c);
        for (; d = u[o ? "prev" : "next"](); ) {
            if ("false" === e.getContentEditableParent(d) || Bf(d, s))
                return I.none();
            if (er(d) && d.data.length > 0)
                return Of(d, s, "A") ? I.none() : I.some(Vi(d, o ? d.data.length : 0));
      ...
      , Lf = (e, t, n, o) => {
        ...
        if (Ur(i))
            return I.none();
        if (qo(i) && l > i.childNodes.length - 1 && (u = !1),
        rr(i) && (i = r,
        l = 0),
        i === r) {
        ...
        if (t === o && er(t)) {
            if (n > 0 && n < t.data.length)
                ...
                r > n) {
                    ...
                    r = 0
        } else if (er(t) && n > 0 && n < t.data.length && (t = If(t, n),
        n = 0),
      ...
      , Uf = e => ({
        ...
        ,
        normalize: t => Mf(e, t).fold(L, (e => (t.setStart(e.startContainer, e.startOffset),
    ...
    const qf = e => "textarea" === Ht(e)
      , Vf = (e, t) => {
        const n = (e => {
            const t = e.dom.ownerDocument
              ...
              , r = t.documentElement;
            if (n === e.dom)
                return To(n.offsetLeft, n.offsetTop);
      ...
      , Kf = (e, t, n, o, r) => {
        ...
        ( (e, t) => e.dispatch("ScrollIntoView", t).isDefaultPrevented())(e, s) || (n(e, t, Po(t).top, o, r),
        ( (e, t) => {
      ...
      , pg = e => {
        const t = (e => e.inline || At.browser.isFirefox())(e) ? (n = yn(e.getBody()),
        (e => {
      ...
      , hg = e => (e.bookmark ? e.bookmark : I.none()).bind((t => {
        return n = yn(e.getBody()),
        o = t,
        I.from(o).filter(mg(n)).map(cg);
        var n, o
    }
    )).bind(gg)
      , bg = {
    ...
    const Cg = za.DOM
      ...
      , kg = (e, t) => {
        ...
        !e.activeEditor && yg && (Cg.unbind(document, "focusin", yg),
        yg = null)
    }
      , Sg = (e, t) => {
    ...
    class Wg {
        ...
        getAll(e) {
            const t = this
              , n = [];
            for (let o = t.firstChild; o; o = $g(o, t))
                o.name === e && n.push(o);
            return n
        }
        children() {
        ...
        empty() {
            ...
            if (e.firstChild) {
                const t = [];
                for (let n = e.firstChild; n; n = $g(n, e))
                    t.push(n);
                let n = t.length;
                for (; n--; ) {
                    const e = t[n];
    ...
    const Kg = Pt.makeMap("NOSCRIPT STYLE SCRIPT XMP IFRAME NOEMBED NOFRAMES PLAINTEXT", " ")
      ...
      , ap = e => {
        ...
        V(t, (e => {
            "all" === en(e, "data-mce-bogus") ? xo(e) : Er(e) ? (po(e, vn(hr)),
            xo(e)) : Eo(e)
        }
        ))
    }
    ...
    const fp = ["font", "text-decoration", "text-emphasis"]
      ...
      , sh = (e, t, n, o) => {
        const r = t.data
          , s = Vi(t, 0);
        return n || !oh(r, 0) || nh(e, s, o) ? !!(n && rh(r, 0) && eh(e, s, o)) && (t.data = br + r.slice(1),
        !0) : (t.data = " " + r.slice(1),
        !0)
    }
      , ah = (e, t, n, o) => {
        const r = t.data
          , s = Vi(t, r.length - 1);
        return n || !oh(r, r.length - 1) || nh(e, s, o) ? !!(n && rh(r, r.length - 1) && th(e, s, o)) && (t.data = r.slice(0, -1) + br,
        !0) : (t.data = r.slice(0, -1) + " ",
        !0)
    }
      , ih = (e, t, n) => {
        const o = t.container();
      ...
      , uh = (e, t, n, o, r=!0) => {
        const s = Ke(e.data).length
          , a = r ? e : t
          , i = r ? t : e;
        return r ? a.appendData(i.data) : a.insertData(0, i.data),
        xo(yn(i)),
        o && dh(a, s, n),
        a
    }
      ...
      , fh = e => {
        ...
        er(t) ? Vi(t, t.data.length) : Vi.after(t))) : e.previousSibling ? Bu(e.previousSibling) : I.none();
        var t
    }
      , gh = e => {
        return ts(e.nextSibling) ? I.some((t = e.nextSibling,
        er(t) ? Vi(t, 0) : Vi.before(t))) : e.nextSibling ? Ou(e.nextSibling) : I.none();
        var t
    }
      ...
      , vh = (e, t, n, o=!0, r=!1) => {
        ...
        const l = ( (e, t, n, o) => {
            ...
            d = (e, t, r) => {
                const s = e.dom
                  ...
                  , i = s.data.length;
                return uh(s, a, n, o),
                r.container() === a ? Vi(s, i) : r
            }
            ,
            a.isSome() && i.isSome() && l.isSome() ? I.some(d(a.getOrDie(), i.getOrDie(), l.getOrDie())) : I.none()).orThunk(( () => (o && (r.each((e => ch(e.dom, e.dom.length, n))),
        ...
        e.selection.setCursorLocation()) : a.bind((e => ( (e, t) => {
            if (gs(e)) {
      ...
      , Ph = (e, t, n, o=!0) => {
        ...
        if (a.dom === e.getBody() ? Th(e, o) : gs(a) && (Or(a),
      ...
      , Yh = (e, t) => {
        ...
        return ( (e, t, n) => e.exists((e => ( (e, t) => !jh(e) && Hh(e, t).exists((e => {
            ...
            if (r.length > 0) {
                if (o)
                    return I.some(Uh.partialTable(r, I.none()));
                {
                    const e = Kh(n, t);
      ...
      , Qh = e => {
        ...
        cr(n.dom) && gs(n) ? e.selection.setCursorLocation(n.dom, 0) : e.selection.collapse(!0),
      ...
      , hb = (e, t, n, o) => {
        if ((e.pad_empty_with_br || t.insert) && n(o)) {
            const e = new Wg("br",1);
            t.insert && e.attr("data-mce-bogus", "1"),
            o.empty().append(e)
        } else
            o.empty().append(new Wg("#text",3)).value = br
    }
      , bb = (e, t) => {
      ...
      , Cb = (e, t, n=e.parent) => {
        if (t.getSpecialElements()[e.name])
            ...
            const o = e.children();
            for (const e of o)
                n && !t.isValidChild(n.name, e.name) && Cb(e, t, n);
            e.unwrap()
        }
    }
      , wb = (e, t, n, o=_) => {
        ...
        for (let n = 0; n < e.length; n++) {
            ...
            if (c && f.length > 1)
                if (xb(t, i, c))
                    ...
                    vb(t, s, a, u) ? c.insert(i, f[0], !0) : (c.insert(u, f[0], !0),
                    c.insert(i, u)),
                    c = f[0],
      ...
      , Ob = (e, t, n) => {
        ...
        ( (e, t) => {
            ...
            u && a.isEmpty(u)) {
                ...
                d.setStart(u, 0),
                d.setEnd(u, 0),
                t || (e => !!e.getAttribute("data-mce-fragment"))(u) || !(s = (t => {
                    let n = Vi.fromRangeStart(t);
                    return n = wu(e.getBody()).next(n),
      ...
      , Ib = (e, t, n) => {
        ...
        if (o)
            for (let n = 0; n < o.length; n++) {
                const r = o[n];
                if (Sm(r) && !1 === r.inherit && e.dom.is(t, r.selector))
                    return !0
            }
        return !1
    }
        ...
        if (a)
            if (Se(a)) {
                for (let n = 0; n < a.length; n++)
                    if (i ? e.getAttrib(t, a[n]) : wm(e, t, a[n]))
                        return !0
            } else
                for (const o in a)
                    if (Ee(a, o)) {
      ...
      , Wb = (e, t, n) => {
        ...
        if (Am(t))
            ...
            const e = r.getRng()
              ...
              , d = (e => {
                const t = qb(e);
                return t && t.data.charAt(0) === $b && t.deleteData(0, 1),
                t
            }
            )(t);
            o.remove(t, !0),
    ...
    const nv = ["fontWeight", "fontStyle", "color", "fontSize", "fontFamily"]
      ...
      , wv = (e, t, n) => {
        ...
        return er(o) && n && r >= o.data.length && (o = new jo(o,e.getBody()).next() || o),
      ...
      , kv = (e, t, n) => {
        ...
        km(n) && o === s.getRoot() && (n.list_block && yv(t, n.list_block) || V(ce(t.childNodes), (t => {
            pm(e, a, t.nodeName.toLowerCase()) ? r ? r.appendChild(t) : (r = Ev(s, t, a),
            s.setAttribs(r, Fl(e))) : r = null
        }
        ))),
      ...
      , Rv = (e, t, n, o, r) => {
        ...
        vv(n.styles, ( (a, i) => {
            const {name: l, value: d} = Sv(i, a, o)
              , c = Cm(d, l);
            (n.remove_similar || h(d) || !qo(r) || yv(wm(e, r, l), c)) && e.setStyle(t, l, ""),
            s = !0
        }
        )),
        s && Nv(e, t)
      ...
      , Av = (e, t, n, o, r) => {
        const s = e.dom
          , a = ub(e)
          , i = e.schema;
        if (Nm(t) && Rs(i, t.inline) && Ts(i, o) && o.parentElement === e.getBody())
            return kv(e, o, t),
            hv.removed();
        ...
        if ("all" !== t.remove) {
            ...
            vv(t.attributes, ( (e, o) => {
                ...
                if (t.remove_similar || h(i) || !qo(r) || yv(s.getAttrib(r, a), i)) {
                    ...
                    if (bv.test(a) && l.removeAttribute("data-mce-" + a),
                    "style" === a && Ko(["li"])(l) && "none" === s.getStyle(l, "list-style-type"))
            ...
            vv(t.classes, (e => {
                e = vm(e, n),
                qo(r) && !s.hasClass(r, e) || s.removeClass(l, e)
            }
            ));
        ...
        return "none" !== t.remove ? (kv(e, l, t),
        hv.removed()) : hv.keep()
    }
      , Tv = (e, t, n, o) => Av(e, t, n, o, o).fold(N(o), (t => (e.dom.createFragment().appendChild(o),
    e.dom.rename(o, t))), N(null))
      , Ov = (e, t, n, o, r) => {
        (o || e.selection.isEditable()) && ( (e, t, n, o, r) => {
            const s = e.formatter.get(t)
                ...
                return ( (e, t, n, o, r, s, a, i) => {
                    ...
                    if (n) {
                        ...
                        for (let n = o.parentNode; n && n !== s; n = n.parentNode) {
                            let o = m.clone(n, !1);
                            for (let n = 0; n < t.length && (o = Tv(e, t[n], i, o),
                            null !== o); n++)
                                ;
                            o && (c && o.appendChild(c),
                            u || (u = o),
              ...
              , m = e => {
                ...
                if (t) {
                    ...
                    return (e => Ku(e) && qo(e) && ("_start" === e.id || "_end" === e.id))(n) && (n = n[e ? "firstChild" : "lastChild"]),
                    er(n) && 0 === n.data.length && (n = e ? t.previousSibling || t.nextSibling : t.nextSibling || t.previousSibling),
                    i.remove(t, !0),
                    n
                }
                return null
            ...
            if (o) {
                ...
                l.isCollapsed() && Nm(a) && !em(e).length ? Xb(e, t, n, r) : (um(e, ( () => im(e, f)), (o => Nm(a) && Hb(e, t, n, o))),
                e.nodeChanged()),
                ( (e, t, n) => {
                    "removeformat" === t ? V(iv(e.selection), (t => {
                        V(nv, (n => e.dom.setStyle(t, n, ""))),
                        Nv(e.dom, t)
                    }
      ...
      , Bv = (e, t, n, o, r) => Av(e, t, n, o, r).fold(L, (t => (e.dom.rename(o, t),
    !0)), M)
      , Pv = Pt.each
      , Dv = Pt.each
      , Lv = (e, t, n, o) => {
      ...
      , Mv = (e, t, n, o) => {
        const r = e.formatter.get(t)
          ...
          , c = (e, t) => {
            let n = !1;
            return Dv(e, (e => !(!Sm(e) || ("false" !== i.getContentEditable(t) || e.ceFalseOverride) && (!C(e.collapsed) || e.collapsed === a) && i.is(t, e.selector) && !Du(t) && (d(t, e),
            n = !0,
            1)))),
            n
        }
          ...
          , f = (o, a, i) => {
            ...
            Wm(o, a, (a => {
                ...
                const p = a => {
                    ...
                    if (ar(a) && !( (e, t, n, o) => {
                        ...
                        return u = null,
                        void (km(s) && o.remove(a));
                    if ((o => (e => km(e) && !0 === e.wrapper)(s) && jb(e, o, t, n))(a))
                        u = null;
                    else {
                        if (( (t, n, o) => {
            ...
            V(l, (a => {
                ...
                ( (e, t, n, o, r) => {
                    ...
                    jb(e, s, n, o) && Bv(e, t, o, r) || t.merge_with_parents && s && e.dom.getParent(s, (s => !!jb(e, s, n, o) && (Bv(e, t, o, r),
                    !0)))
                }
                )(e, s, t, n, a),
                ( (e, t, n, o) => {
                ...
                ( (e, t, n, o) => {
                    ...
                    ;
                    t.styles && (t.styles.color || t.styles.textDecoration) && (Pt.walk(o, r, "childNodes"),
                    r(o))
                }
                )(o, s, 0, a),
                ( (e, t, n, o) => {
            ...
            if (o)
                ...
                a && Nm(s) && !em(e).length ? ( (e, t, n) => {
                    ...
                    if (l && i > 0 && i < l.length && d.test(l.charAt(i)) && d.test(l.charAt(i - 1))) {
                        ...
                        let s = o ? qb(o) : null;
                        o && (null == s ? void 0 : s.data) === $b || (c = e.getDoc(),
                        u = Vb(!0).dom,
                        o = c.importNode(u, !0),
                        s = o.firstChild,
                        a.insertNode(o),
      ...
      , Hv = (e, t, n) => {
        ...
        ge(n, ( (n, r) => {
            ...
            ;
            V([n.withSimilar, n.withoutSimilar], s),
            V(n.withVars, s)
        }
        ))
    }
      ...
      , Vv = (e, t, n) => {
        ...
        )(e, r, Pt.explode(null !== (o = t.font_size_legacy_values) && void 0 !== o ? o : "")),
        ( (e, t, n) => {
        ...
        t.addNodeFilter("br", ( (t, o, r) => {
            ...
            for (let o = 0, d = t.length; o < d; o++) {
                ...
                if (c && l(c) && d === c.lastChild) {
                    ...
                    let e = d;
                    for (; c && c.firstChild === e && c.lastChild === e && (e = c,
                    !s[c.name]); )
                        c = c.parent;
                    if (e === c) {
    ...
    const Qv = (e, t, n) => Kv(e).bind(( ({data: e, type: o, base64Encoded: r}) => {
      ...
      , ty = (e, t) => {
        ...
        t.convert_unsafe_embeds && e.addNodeFilter("object,embed", (e => V(e, (e => {
            e.replace(( (e, t, n, o, r) => {
                let s;
    ...
    var Xy = function e() {
        ...
        let C, w = "";
        const {implementation: x, createNodeIterator: E, createDocumentFragment: _, getElementsByTagName: k} = s
          , {importNode: S} = o;
        let N = {};
        ...
        const xe = s.createElement("form")
          ...
          , _e = function(e) {
            if (!we || we !== e) {
                ...
                he = "ALLOWED_NAMESPACES"in e ? ky({}, e.ALLOWED_NAMESPACES, hy) : be,
                de = "ADD_URI_SAFE_ATTR"in e ? ky(Sy(ce), e.ADD_URI_SAFE_ATTR, Ce) : ce,
                ie = "ADD_DATA_URI_TAGS"in e ? ky(Sy(le), e.ADD_DATA_URI_TAGS, Ce) : le,
                ...
                e.CUSTOM_ELEMENT_HANDLING && Ee(e.CUSTOM_ELEMENT_HANDLING.tagNameCheck) && (z.tagNameCheck = e.CUSTOM_ELEMENT_HANDLING.tagNameCheck),
                e.CUSTOM_ELEMENT_HANDLING && Ee(e.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) && (z.attributeNameCheck = e.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),
                e.CUSTOM_ELEMENT_HANDLING && "boolean" == typeof e.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements && (z.allowCustomizedBuiltInElements = e.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),
                K && (q = !1),
                J && (Q = !0),
                re && (M = ky({}, [...Dy]),
                F = [],
                ...
                ky(F, My),
                ky(F, Fy)),
                !0 === re.svgFilters && (ky(M, Ty),
                ky(F, My),
                ky(F, Fy)),
                !0 === re.mathMl && (ky(M, By),
                ky(F, Iy),
                ky(F, Fy))),
                e.ADD_TAGS && (M === I && (M = Sy(M)),
                ky(M, e.ADD_TAGS, Ce)),
                e.ADD_ATTR && (F === U && (F = Sy(F)),
                ky(F, e.ADD_ATTR, Ce)),
                e.ADD_URI_SAFE_ATTR && ky(de, e.ADD_URI_SAFE_ATTR, Ce),
                e.FORBID_CONTENTS && (se === ae && (se = Sy(se)),
                ky(se, e.FORBID_CONTENTS, Ce)),
                ne && (M["#text"] = !0),
                ...
                e.TRUSTED_TYPES_POLICY) {
                    if ("function" != typeof e.TRUSTED_TYPES_POLICY.createHTML)
                        throw xy('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');
                    if ("function" != typeof e.TRUSTED_TYPES_POLICY.createScriptURL)
                        throw xy('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');
                    C = e.TRUSTED_TYPES_POLICY,
                    w = C.createHTML("")
                } else
                    void 0 === C && (C = function(e, t) {
        ...
        const Te = function(e) {
          ...
          , Be = function(e) {
            ...
            return e && n && r.insertBefore(s.createTextNode(n), r.childNodes[0] || null),
            ge === fe ? k.call(t, Y ? "html" : "body")[0] : Y ? t.documentElement : r
        }
          , Pe = function(e) {
          ...
          , Me = function(e) {
            let t;
            if (Le("beforeSanitizeElements", e, null),
            (o = e)instanceof m && ("string" != typeof o.nodeName || "string" != typeof o.textContent || "function" != typeof o.removeChild || !(o.attributes instanceof u) || "function" != typeof o.removeAttribute || "function" != typeof o.setAttribute || "string" != typeof o.namespaceURI || "function" != typeof o.insertBefore || "function" != typeof o.hasChildNodes))
                return Te(e),
                !0;
            var o;
            ...
            e.hasChildNodes() && !De(e.firstElementChild) && (!De(e.content) || !De(e.content.firstElementChild)) && wy(/<[/\w]/g, e.innerHTML) && wy(/<[/\w]/g, e.textContent))
                return Te(e),
                !0;
            if (!M[r] || j[r]) {
                if (!j[r] && Fe(r)) {
            ...
            !0) : "noscript" !== r && "noembed" !== r && "noframes" !== r || !wy(/<\/no(script|embed|frames)/i, e.innerHTML) ? (K && 3 === e.nodeType && (t = e.textContent,
            t = vy(t, R, " "),
            t = vy(t, A, " "),
            t = vy(t, T, " "),
            e.textContent !== t && (gy(n.removed, {
                element: e.cloneNode()
            }),
            e.textContent = t)),
          ...
          , Ie = function(e, t, n) {
            ...
            if (q && !H[t] && wy(O, t))
                ...
                if (!(Fe(e) && (z.tagNameCheck instanceof RegExp && wy(z.tagNameCheck, e) || z.tagNameCheck instanceof Function && z.tagNameCheck(e)) && (z.attributeNameCheck instanceof RegExp && wy(z.attributeNameCheck, t) || z.attributeNameCheck instanceof Function && z.attributeNameCheck(t)) || "is" === t && z.allowCustomizedBuiltInElements && (z.tagNameCheck instanceof RegExp && wy(z.tagNameCheck, n) || z.tagNameCheck instanceof Function && z.tagNameCheck(n))))
                    return !1
            } else if (de[t])
                ;
            else if (wy(L, vy(n, D, "")))
          ...
          , ze = function e(t) {
            ...
            for (Le("beforeSanitizeShadowDOM", t, null); n = o.nextNode(); )
                ...
                Me(n) || (n.content instanceof a && e(n.content),
                Ue(n));
        ...
        return n.sanitize = function(e) {
            ...
            if (G || _e(d),
            n.removed = [],
            "string" == typeof e && (oe = !1),
            oe) {
                if (e.nodeName) {
                    const t = Ce(e.nodeName);
                    if (!M[t] || j[t])
                        throw xy("root node is forbidden and cannot be sanitized in-place")
                }
            ...
            const c = Pe(oe ? e : t);
            for (; s = c.nextNode(); )
                Me(s) || (s.content instanceof a && ze(s.content),
                Ue(s));
            if (oe)
                return e;
            if (Q) {
                if (J)
                    ...
                    i = t;
                return (F.shadowroot || F.shadowrootmode) && (i = S.call(o, i, !0)),
                i
            }
    ...
    const iC = (e, t, n, o, r) => {
        ...
        if (1 !== e.nodeType || "body" === u)
            return;
        const f = yn(e)
          , g = nn(f, sC)
          , p = en(f, "data-mce-bogus");
        if (!g && m(p))
            return void ("all" === p ? xo(f) : Eo(f));
        const h = n.getElementRule(u);
        if (!d || h) {
            if (C(r) && (r.allowedTags[u] = !0),
            d && h && !g) {
      ...
      , mC = (e, t, n) => {
        ...
        o.addHook("uponSanitizeAttribute", ( (o, r) => {
            ( (e, t, n, o, r) => {
                ...
                r.keepAttr ? (r.allowedAttributes[a] = !0,
                cC(a, n) && (r.attrValue = a),
                t.allow_svg_data_urls && He(i, "data:image/svg+xml") && (r.forceKeepAttr = !0)) : dC(e, a) && (r.forceKeepAttr = !0)
            }
            )(o, e, t, n.current(), r)
        }
        )),
      ...
      , hC = (e, t, n, o) => {
        ...
        for (let t = 0, r = a.length; t < r; t++) {
            ...
            if (qo(r)) {
                ...
                er(r) ? (i.value = r.data,
                s && (i.raw = !0)) : (or(r) || tr(r) || nr(r)) && (i.value = r.data);
            ps(i.name) || hC(i, r, n, o),
            e.append(i)
        }
    }
      , bC = (e={}, t=ua()) => {
            ...
            parse: (e, n={}) => {
                ...
                const i = r.validate
                  ...
                  , c = ( (e, n, o="html") => {
                    ...
                    return a.sanitizeHtmlElement(c, r),
                    i ? c.firstChild : c
                }
                )(e, d, n.format);
                ks(t, c);
      ...
      , wC = (e, t) => {
            ...
            return pl.value(t);
        {
            ...
            return n.isDefaultPrevented() ? (of(e, n),
            pl.error(void 0)) : pl.value(n)
        }
    }
      , xC = (e, t, n) => {
        n.no_events || of(e, {
    ...
    t)
        ...
        editor: {
            ...
            setContent: (t, n) => ( (e, t, n) => I.from(e.getBody()).map((o => Bb(t) ? ( (e, t, n, o) => {
                ...
                if (0 === (n = Dr(n)).length || /^\s+$/.test(n)) {
                    ...
                    n = e.dom.createHTML(s, Fl(e), n)) : n || (n = r),
      ...
      , ew = e => 0 === e.dom.length ? (xo(e),
    I.none()) : I.some(e)
      , tw = (e, t, n, o, r) => {
        e.bind((e => ((o ? ch : dh)(e.dom, o ? e.dom.length : 0, r),
        t.filter(Kt).map((t => ( (e, t, n, o, r) => {
            const s = e.dom
              , a = t.dom
              , i = o ? s.length : a.length;
            o ? (uh(s, a, r, !1, !o),
            n.setStart(a, i)) : (uh(a, s, r, !1, !o),
            n.setEnd(a, i))
        }
        )(e, t, n, o, r)))))).orThunk(( () => {
      ...
      , rw = (e, t, n, o) => {
        ...
        const {selectorChangedWithUnbind: a} = ( (e, t) => {
          ...
          , c = () => {
            ...
            try {
                const e = d();
                e && !$o(e.anchorNode) && (n = e.rangeCount > 0 ? e.getRangeAt(0) : i.createRange(),
                n = Mg(o, [n])[0])
            } catch (e) {}
            if (n || (n = i.createRange()),
            rr(n.startContainer) && n.collapsed) {
                const t = e.getRoot();
                n.setStart(t, 0),
                n.setEnd(t, 0)
            }
          ...
          , f = {
            ...
            getNode: () => ( (e, t) => {
                ...
                er(n) && er(o) && (n = n.length === r ? Lg(n.nextSibling, !0) : n.parentNode,
      ...
      , Tw = e => {
        const t = []
          ...
          , a = (a, i=!0) => e.removed || !(e => {
            ...
            I.from(t).map(yn)).map(Gn).getOr(!1);
            var t
        }
        ...
        J(t, (e => {
            ...
            const i = n().open(a, ( () => {
                s(i),
                r(),
                Ag(e) && o().fold(( () => e.focus()), (e => ag(yn(e.getEl()))))
            }
            ));
            return (e => {
                t.push(e)
                        ...
                        }));
                    {
                        const r = ( (e, t) => {
                            ...
                            if (He(t, "blob:")) {
                                ...
                                He(o, "blob:") ? (e => fetch(e).then((e => e.ok ? e.blob() : Promise.reject())).catch(( () => Promise.reject({
    ...
    const qw = (e, t) => {
        ...
        ;
        return {
            upload: (l, d) => t.url || r !== o ? ( (t, o) => (t = Pt.grep(t, (t => !e.isUploaded(t.blobUri()))),
            Promise.all(Pt.map(t, (t => e.isPending(t.blobUri()) ? (e => {
                const t = e.blobUri();
      ...
      , Kw = e => {
        const t = ( () => {
            ...
            return {
                ...
                findFirst: n,
                removeByUri: t => {
                    e = Y(e, (e => e.blobUri() !== t || (URL.revokeObjectURL(e.blobUri()),
                    !1)))
                }
                ,
                destroy: () => {
        ...
        p().then(a((o => {
            ...
            return n.upload(r, Vw(e)).then(a((n => {
                ...
                const a = q(n, ( (n, a) => {
                    ...
                    let c = !1;
                    return n.status && Wl(e) ? (n.url && !je(l.src, n.url) && (s = !0),
                    t.removeByUri(l.src),
                    XC(e) || ( (t, n) => {
      ...
      , ox = (e, t) => {
        ...
        return Jw(o.split(" "), (e => {
            ...
            "#ffffff" === Ca(t).toLowerCase()) || "color" === e && "#000000" === Ca(t).toLowerCase())) {
            ...
            e.on("mouseup keydown", (t => {
                ...
                ( (e, t, n) => {
                    const o = e.selection
                      , r = e.getBody();
                    Kb(e, null, n),
                    8 !== t && 46 !== t || !o.isCollapsed() || o.getStart().innerHTML !== $b || Kb(e, Lu(r, o.getStart()), !0),
                    37 !== t && 39 !== t || Kb(e, Lu(r, o.getStart()), !0)
                }
                )(e, t.keyCode, (n = e.selection.getRng().endContainer,
                er(n) && $e(n.data, br)))
            }
            ))
        }
      ...
      , ax = e => {
        ...
        return XC(e) || ( (e, t, n) => {
            ...
            e.on("keyup", (n => {
                ...
                (s >= 33 && s <= 36 || s >= 37 && s <= 40 || 45 === s || n.ctrlKey || a) && (r(),
                e.nodeChanged()),
                46 !== s && 8 !== s || e.nodeChanged(),
                o.get() && t.typing && !VC(jC(e), t.data[0]) && (e.isDirty() || e.setDirty(!0),
    ...
    ( (e, t) => kn(t, e) ? ( (e, t) => {
      ...
      , Ox = (e, t) => ( (e, t) => {
        const n = e.selection.getRng();
        if (!er(n.commonAncestorContainer))
            return I.none();
        ...
        if (!d || !du(i, d))
            return I.none();
        if (a(d))
            return I.some(( () => Tx(e, n, i.getNode(), o, t, d)));
        const c = s(d);
      ...
      , Ix = (e, t) => {
        ...
        )(e.getBody(), t, e.selection.getRng(), e.schema).map((n => () => n.fold(( (e, t) => n => (e._selectionOverrides.hideFakeCaret(),
        vh(e, t, yn(n)),
        !0))(e, t), ( (e, t) => n => {
      ...
      , Vx = (e, t) => e ? (e => {
        ...
        if (jx(e.previousSibling))
            return $x(e.previousSibling) || e.previousSibling.appendData(Br),
            e.previousSibling;
        if (jx(e))
            return Hx(e) || e.insertData(0, Br),
            e;
        {
            const n = qx(e);
        ...
        var t, n;
        if (jx(e.nextSibling))
            return Hx(e.nextSibling) || e.nextSibling.insertData(0, Br),
            e.nextSibling;
        if (jx(e))
            return $x(e) || e.appendData(Br),
            e;
        {
            const o = qx(e);
      ...
      , pE = (e, t, n) => {
        const o = e ? 1 : -1;
        return t.setRng(Vi(n.container(), n.offset() + o).toRange()),
    ...
    const UE = (e, t, n, o, r, s) => {
      ...
      , KE = (e, t, n, o, r, s) => {
        ...
        if (!n.collapsed) {
            const o = _i(n);
            if (s(o))
                return kx(t, e, o, t === cu.Backwards, !1);
            if (Px(e)) {
                const e = n.cloneRange();
                return e.collapse(t === cu.Backwards),
                I.from(e)
            }
        }
        const c = au(t, e.getBody(), n);
        if (d(c))
            return Sx(e, c.getNode(!a));
        let u = l(c);
        const m = Wr(n);
        if (!u)
      ...
      , YE = (e, t, n, o, r, s) => {
        ...
        let g;
        if (g = o(a) ? a.getNode() : r(a) ? a.getNode(!0) : _i(n),
        g) {
            const n = ( (e, t, n, o) => {
                const r = wu(t);
                let s, a, i, l;
            ...
            let o = LE(Y(n, qE(1)), m);
            if (o)
                return WE(e, o.position.toRange(), !1);
            if (o = Pe(Y(n, qE(0))),
            o)
                return WE(e, o.position.toRange(), !1)
        }
      ...
      , GE = (e, t) => {
        const n = e.selection.getRng()
          ...
          , r = (s = o.container(),
        a = e.getBody(),
        Qn(yn(s), (e => Ic(e.dom)), (e => e.dom === a)).map((e => e.dom)).getOr(a));
        var s, a;
        if (t) {
            const e = kE(r, o);
      ...
      , XE = (e, t, n) => GE(e, t).filter(n).exists((t => (e.selection.setRng(t.toRange()),
    !0)))
      , QE = (e, t) => {
    ...
    n)))
        ...
        return e.on("NodeChange", (o => {
            ...
            ( (e, t) => {
                ...
                if (e.selection.isCollapsed() && !e.composing && n) {
                    ...
                    Vi.isTextPosition(o) && !(e => jr(e) || Hr(e))(o) && (QE(e, Nc(n, o)),
                    t.set(null))
                }
            }
            )(e, t),
      ...
      , l_ = (e, t, n, o) => {
        ...
        e.undoManager.ignore(( () => {
            ...
            Nh(e),
            iE(s, r, Vi.fromRangeStart(e.selection.getRng())).map(uE).bind(i_(e, t)).each(D)
        }
        )),
        e.nodeChanged()
    }
    ...
    !0)
      ...
      , F_ = e => {
        ...
        if (!o.isValidChild(u, c.toLowerCase()) || ( (e, t, n) => $(Op(yn(n), yn(t)), (t => D_(e, t.dom))))(r, a, s))
            return;
        const m = n.getRng()
      ...
      , H_ = (e, t) => {
        t.hasAttribute("data-mce-caret") && (Vr(t),
      ...
      , W_ = (e, t) => ( (e, t) => {
        const n = t ? cu.Forwards : cu.Backwards
          , o = e.selection.getRng();
        return ( (e, t, n) => KE(t, e, n, Ap, Tp, q_))(n, e, o).orThunk(( () => (V_(e, n, o),
        I.none())))
    }
    )(e, ( (e, t) => {
    ...
    )(e.selection, t)).exists((t => (VE(e, t),
    !0)))
      , K_ = (e, t) => ( (e, t) => {
        const n = t ? 1 : -1
          , o = e.selection.getRng();
        return ( (e, t, n) => YE(t, e, n, (e => Ap(e) || Np(e)), (e => Tp(e) || Rp(e)), q_))(n, e, o).orThunk(( () => (V_(e, n, o),
        I.none())))
    }
    )(e, t).exists((t => (VE(e, t),
    !0)))
    ...
    !0)))
      ...
      , J_ = (e, t) => ( (e, t) => t ? I.from(e.dom.getParent(e.selection.getNode(), "details")).map((t => ( (e, t) => {
        const n = e.selection.getRng()
          , o = Vi.fromRangeStart(n);
        return !(e.getBody().lastChild !== t || !AE(t, o) || (e.execCommand("InsertNewBlockAfter"),
        0))
    }
    )(e, t))).getOr(!1) : I.from(e.dom.getParent(e.selection.getNode(), "summary")).bind((t => I.from(e.dom.getParent(t, "details")).map((n => ( (e, t, n) => {
        const o = e.selection.getRng()
          , r = Vi.fromRangeStart(o);
        return !(e.getBody().firstChild !== t || !RE(n, r) || (e.execCommand("InsertNewBlockBefore"),
        0))
    }
    )(e, n, t))))).getOr(!1))(e, t)
      , Z_ = {
      ...
      , rk = (e, t) => {
        const n = t ? cu.Forwards : cu.Backwards
          , o = e.selection.getRng();
        return KE(e, n, o, kp, Sp, mr).exists((t => (VE(e, t),
        !0)))
    }
      , sk = (e, t) => {
        const n = t ? 1 : -1
          , o = e.selection.getRng();
        return YE(e, n, o, kp, Sp, mr).exists((t => (VE(e, t),
        !0)))
    }
    ...
    Sk(e, t, n))))
      , Sk = (e, t, n) => {
        return kk(e, t, (r = oo,
        mk(o = n, void 0).fold(( () => lk.none(o)), (e => uk(e.all, o, e.index, 1, r)))));
        var o, r
    }
      , Nk = (e, t, n) => {
        return kk(e, t, (r = oo,
        mk(o = n, void 0).fold(( () => lk.none()), (e => uk(e.all, o, e.index, -1, r)))));
        var o, r
    }
      , Rk = (e, t) => {
        const n = ["table", "li", "dl"]
      ...
      , Uk = (e, t, n, o=0) => {
        return (r = yn(t.startContainer),
        no(r, Ug)).fold(( () => ( (e, t, n, o=0) => {
            if (!(r = t).collapsed || !er(r.startContainer))
                return I.none();
            var r;
            const s = {
                text: "",
            ...
            return Lk(e, t.startContainer, t.startOffset, ( (e, t, o) => (s.text = o + s.text,
            s.offset += t,
            ( (e, t, n) => {
                let o;
                const r = n.charAt(0);
    ...
    e => ({
      ...
      , _S = (e, t) => ES(e, t, mS)
      , kS = (e, t, n) => ES(e, t, (e => {
        return t = t => H(e, t) ? pl.value(t) : pl.error(`Unsupported value: "${t}", choose one of "${e.join(", ")}".`),
        nS((e => t(e).fold(Wk, Vk)));
        var t
    }
    )(n))
      ...
      , zS = aS([RS, yS("trigger"), _S("minChars", 1), (1,
    ( (e, t) => hS(e, e, Zk(1), cS()))("columns")), _S("maxResults", 10), ("matches",
    wS("matches", pS)), AS, TS, (jS = fS,
    ES("highlightOn", [], iS(jS)))]);
    var jS;
    ...
    const XS = e => {
      ...
      , iN = (e, t, n) => ( (e, t, n) => ( (e, t) => {
        ...
        return !!pr(r) && ("selection" === n && eN(s, r) || Oh(t, a, r) ? ZS(r) : e.undoManager.transact(( () => {
            ...
            !o.isCollapsed() && eN(o.getRng(), m) ? ZS(r) : (e.execCommand(t ? "ForwardDelete" : "Delete"),
      ...
      , pN = (e, t) => {
        ...
        t.hasChildNodes()) {
            ...
            ar(t) ? t.nextSibling && n.isBlock(t.nextSibling) ? (r.setStartBefore(t),
        ...
        if (r) {
            do {
                if (m[u.nodeName]) {
                    ...
                    i.setAttrib(e, "id", ""),
                    f.hasChildNodes() ? (e.appendChild(f.firstChild),
                    f.appendChild(e)) : (g = e,
                    f.appendChild(e))
                }
            } while ((u = u.parentNode) && u !== o)
        } else
            i.setAttrib(f, "style", null),
            i.setAttrib(f, "class", null);
        return yN(e, f),
        vN(g),
        f
    }
      ...
      , ON = {
        insert: (e, t) => {
            ...
            const i = e.dom
              ...
              , v = e => {
                const t = TN(e, n, o);
                if (er(n) && (e ? t > 0 : t < n.data.length))
                    return !1;
                if (n.parentNode === k && a && !e)
                    return !0;
                if (e && qo(n) && n === k.firstChild)
                    return !0;
                if (RN(n, "TABLE") || RN(n, "HR"))
                    return a && !e || !a && e;
                const r = new jo(n,k);
                let s;
              ...
              , w = () => {
                let t;
                return t = /^(H[1-6]|PRE|FIGURE)$/.test(r) && "HGROUP" !== S ? b(c) : b(),
                ( (e, t) => {
                    const n = $l(e);
                    ...
                    includeZwsp: !0
                }) ? t = i.split(s, k) : i.insertAfter(t, k),
                pN(e, t),
                t
            }
            ;
            ...
            const x = !(!t || !t.shiftKey)
              , E = !(!t || !t.ctrlKey);
            qo(n) && n.hasChildNodes() && !p && (a = o > n.childNodes.length - 1,
            ...
            s = C(null == k ? void 0 : k.parentNode) ? i.getParent(k.parentNode, i.isBlock) : null,
            r = k ? k.nodeName.toUpperCase() : "";
            const S = s ? s.nodeName.toUpperCase() : "";
            if ("LI" !== S || E || (k = s,
            s = s.parentNode,
            r = S),
            qo(s) && ( (e, t, n) => !t && n.nodeName.toLowerCase() === Il(e) && e.dom.isEmpty(n) && ( (t, n, o) => {
                let r = n;
                for (; r && r !== t && h(r.nextSibling); ) {
                    const t = r.parentElement;
                    if (!t || (s = t,
                    !Ee(e.schema.getTextBlockElements(), s.nodeName.toLowerCase())))
                        return gr(t);
                    r = t
                }
                var s;
            ...
            if (/^(LI|DT|DD)$/.test(r) && qo(s) && i.isEmpty(k))
                return void ( (e, t, n, o, r) => {
                    ...
                    if (kN(n, o, !0) && kN(n, o, !1))
                        ...
                        wN(n, "LI") ? (s.insertAfter(c, _N(n)),
                        c.appendChild(s.doc.createTextNode(" ")),
                        c.appendChild(n)) : i.insertBefore(c, n),
                        s.remove(o);
                    else if (kN(n, o, !1))
            ...
            if (p)
                ...
                const t = (e => {
                    const t = e.cloneRange();
                    return t.setStart(e.startContainer, TN(!0, e.startContainer, e.startOffset)),
                ...
                ( (e, t, n) => {
                    ...
                    for (; a--; )
                        s = r[a],
                        (!s.hasChildNodes() || s.firstChild === s.lastChild && "" === (null === (o = s.firstChild) || void 0 === o ? void 0 : o.nodeValue) || NN(e, s)) && e.remove(s)
                }
                )(i, l, R),
                ( (e, t) => {
                    t.normalize();
      ...
      , LN = (e, t) => {
        return n = Vi.after(t),
        !!ar(n.getNode()) || Au(e, Vi.after(t)).map((e => ar(e.getNode()))).getOr(!1);
        var n
    }
        ...
        insert: (e, t) => {
            ...
            n.isSome() ? n.each(T(FN, e)) : ( (e, t) => {
                ...
                const c = d && d.parentNode ? o.getParent(d.parentNode, o.isBlock) : null
                  ...
                  , m = !(!t || !t.ctrlKey);
                "LI" !== u || m || (d = c),
                er(l) && i >= l.data.length && (( (e, t, n) => {
                    const o = new jo(t,n);
                    let r;
                    const s = e.getNonEmptyElements();
                    for (; r = o.next(); )
                        if (s[r.nodeName.toLowerCase()] || er(r) && r.length > 0)
                            return !0;
                    return !1
                }
      ...
      , ZN = (e, t, n) => {
        ...
        C(n) && cN(t, e.fakeEventName).isDefaultPrevented() || (e.insert(t, n),
        C(n) && dN(t, e.fakeEventName))
    }
      , eR = (e, t) => {
        const n = () => ZN(UN, e, t)
          , o = () => ZN(ON, e, t)
      ...
      , iR = (e, t, n) => {
        n && !e.get() ? t.on("NodeChange", sR, !0) : !n && e.get() && t.off("NodeChange", sR),
        e.set(n)
    }
      , lR = (e, t) => {
        const n = t.container()
          , o = t.offset();
        return er(n) ? (n.insertData(o, e),
        I.some(Vi(n, o + e.length))) : iu(t).map((n => {
            const o = vn(e);
            return t.isAtEnd() ? ho(n, o) : po(n, o),
            Vi(o.dom, e.length)
        }
        ))
    }
      ...
      , fR = e => {
        return It(At.browser.isFirefox() && e.selection.isEditable() && (t = e.dom,
        n = e.selection.getRng().startContainer,
        t.isEditable(t.getParent(n, "summary"))), ( () => {
            const t = yn(e.getBody());
            e.selection.isCollapsed() || e.getDoc().execCommand("Delete"),
            ( (e, t, n) => Zp(e, t, n) ? dR(t) : cR(t))(t, Vi.fromRangeStart(e.selection.getRng()), e.schema).each(uR(e))
        }
        ));
        var t, n
    }
    ...
    class hR {
        constructor(e) {
            ...
            "onselectionchange"in e.getDoc() || e.on("NodeChange click mouseup keyup focus", (n => {
                ...
                "nodechange" !== n.type && Af(r, t) || e.dispatch("SelectionChange"),
                t = r
            }
            )),
            e.on("contextmenu", ( () => {
    ...
    !0))(e, t, n)
      ...
      , lA = (e, t, n, o, r) => {
        ...
        (o || l) && (s = sA(t, "text/plain") && i ? t["text/plain"] : (e => {
            const t = ua()
              , n = bC({}, t);
            let o = "";
      ...
      , dA = (e, t, n) => {
        ( (e, t, n) => {
            ...
            e.on("paste", (r => {
                ...
                !aA(a) && iA(e, r, t.getLastRng() || e.selection.getRng()) || (sA(a, "text/html") ? (r.preventDefault(),
                lA(e, a, a["text/html"], s, !0)) : sA(a, "text/plain") && sA(a, "text/uri-list") ? (r.preventDefault(),
                lA(e, a, a["text/plain"], s, !0)) : (t.create(),
            ...
            ( (e, t) => {
                ...
                e.on("drop", (n => {
                    ...
                    const a = r[FR()]
                      ...
                      , d = t.get();
                    d && !l || i && (n.preventDefault(),
                    vg.setEditorTimeout(e, ( () => {
                        e.undoManager.transact(( () => {
                            (a || d && l) && e.execCommand("Delete"),
                            pA(e, o);
                            const t = KR(i);
    ...
    const RA = (e, t) => Math.abs(e.left - t)
      ...
      , KA = (e, t) => {
        const n = Qa(( (e, n) => ( (e, t, n) => {
            e._selectionOverrides.hideFakeCaret(),
            PA(e.getBody(), t, n).fold(( () => e.selection.placeCaretAt(t, n)), (o => {
        ...
        return r => e.on((e => {
            ...
            if (!e.dragging && s > 10) {
                ...
                if (C(n.dataTransfer) && (e.dataTransfer = n.dataTransfer),
            ...
            if (e.dragging) {
                ...
                ( (e, t, n, o, r, s, a, i, l, d, c, u) => {
                    ...
                    c.on((e => {
                        e.intervalId.clear(),
                        e.dragging && u && (a + 8 >= g ? e.intervalId.set(qA(d)) : a - 8 <= 0 ? e.intervalId.set($A(d)) : i + 8 >= p ? e.intervalId.set(HA(d)) : i - 8 <= 0 ? e.intervalId.set(jA(d)) : h + 16 >= window.innerHeight ? e.intervalId.set(qA(window)) : h - 16 <= 0 ? e.intervalId.set($A(window)) : b + 16 >= window.innerWidth ? e.intervalId.set(HA(window)) : b - 16 <= 0 && e.intervalId.set(jA(window)))
                    }
                    ))
                }
      ...
      , YA = (e, t, n) => {
        e.on((e => {
            e.intervalId.clear(),
            e.dragging && n.fold(( () => WA(t, "dragend", e.element, e.dataTransfer)), (n => WA(t, "dragend", e.element, e.dataTransfer, n)))
        }
        )),
        GA(e)
    }
      ...
      , ZA = e => {
        ...
        r.show(s, o))
          ...
          , m = t => {
            const o = e.schema.getVoidElements()
              ...
              , i = t.endContainer
              , l = t.endOffset;
            return Ee(o, s.nodeName.toLowerCase()) ? 0 === a ? r.setStartBefore(s) : r.setStartAfter(s) : r.setStart(s, a),
            Ee(o, i.nodeName.toLowerCase()) ? 0 === l ? r.setEndBefore(i) : r.setEndAfter(i) : r.setEnd(i, l),
            r
        }
          , f = (r, c) => {
            if (!r)
            ...
            let m = r.startContainer
              , f = r.startOffset;
            const g = r.endOffset;
            if (er(m) && 0 === f && QA(m.parentNode) && (m = m.parentNode,
            f = n.nodeIndex(m),
            m = m.parentNode),
            !qo(m))
                return null;
        ...
        e.on("tap", (t => {
            const n = t.target
              , o = JA(e, n);
            QA(o) ? (t.preventDefault(),
            Sx(e, o).each(f)) : l(n) && Sx(e, n).each(f)
        }
        ), !0),
        e.on("mousedown", (r => {
            const s = r.target;
            ...
            p();
            const a = JA(e, s);
            QA(a) ? (r.preventDefault(),
            Sx(e, a).each(f)) : PA(o, r.clientX, r.clientY).each((n => {
                var o;
                r.preventDefault(),
                (o = d(1, n.node, n.position === NA.Before, !1)) && t.setRng(o),
            ...
            Id(e) && (e => {
                const t = t => {
                    if (!t.isDefaultPrevented()) {
                        ...
                        "drop" === t.type && Lw(e, "Dropped file type is not supported"))
                    }
                }
                  , n = n => {
                    xg(e, n.target) && t(n)
        ...
        )(e)),
        {
            ...
            showBlockCaretContainer: e => {
                e.hasAttribute("data-mce-caret") && (Vr(e),
                t.scrollIntoView(e))
            }
            ,
            hideFakeCaret: p,
      ...
      , sT = (e, t, n) => {
        if (t && e.isEmpty(t) && !n(t)) {
            const o = t.parentNode;
            e.remove(t, er(t.firstChild) && ss(t.firstChild.data)),
            sT(e, o, n)
        }
    }
      , aT = (e, t, n, o=!0) => {
        ...
        t.deleteContents(),
        o && !n(t.startContainer) && (er(t.startContainer) && 0 === t.startContainer.data.length && e.remove(t.startContainer),
        er(t.endContainer) && 0 === t.endContainer.data.length && e.remove(t.endContainer),
        sT(e, r, n),
        r !== s && sT(e, s, n))
    }
      ...
      , gT = (e, t, n) => {
        sT(e, e.get(t.prefix + "-end"), n),
        sT(e, e.get(t.prefix + "-start"), n)
    }
      , pT = e => 0 === e.start.length
      , hT = (e, t, n, o) => {
        const r = t.start;
        var s;
        return Lk(e, o.container, o.offset, (s = r,
        (e, t) => {
      ...
      , yT = (e, t, n) => {
        e.selection.setRng(n),
        "inline-format" === t.type ? V(t.format, (t => {
            e.formatter.apply(t)
        }
      ...
      , CT = (e, t, n, o, r, s) => {
        ...
        )(vT(e, r.inlinePatterns, n, o, t, s).fold(( () => []), (e => e.matches)), vT(e, (a = r.inlinePatterns,
      ...
      , xT = (e, t) => {
        ...
        return iT(e, n).map((o => {
            ...
            e.undoManager.extra(( () => {
                ...
                n.each((t => {
                    const n = t.container;
                    n.data.charAt(t.offset - 1) === hr && (n.deleteData(t.offset - 1, 1),
      ...
      , _T = e => {
        const t = Pt.each
          ...
          , v = () => {
            ...
            e.on("click", (n => {
                const o = n.target;
                /^(IMG|HR)$/.test(o.nodeName) && r.isEditable(o) && (n.preventDefault(),
          ...
          , k = () => {
            u && e.on("keydown", (t => {
                !af.metaKeyPressed(t) || t.shiftKey || 37 !== t.keyCode && 39 !== t.keyCode || (t.preventDefault(),
        ...
        ( () => {
            ...
            e.on("keypress", (t => {
                let r;
                return !(!(g(t) || 8 !== t.keyCode && 46 !== t.keyCode) && o() && (r = n(),
      ...
      , OT = e => {
        ...
        const a = Promise.all(( (e, t, n) => {
            const {pass: o, fail: r} = K(t, (e => tinymce.Resource.has(Uw(e))))
              , s = o.map((t => {
      ...
      , PT = e => {
        ...
        let n = e.getDoc();
        e.inline && (kT.addClass(t, "mce-content-body"),
        ...
        !e.readonly && e.hasEditableRoot() && (e.inline && "static" === kT.getStyle(o, "position", !0) && (o.style.position = "relative"),
        ...
        (e => {
            ...
            const n = e.dom
              ...
              , s = (t, a) => {
                ...
                ("" !== n.getAttrib(i, lx) !== l || a) && (n.setAttrib(i, lx, l ? r : null),
        ...
        const s = (e => {
            const t = e;
            return (e => xe(e.plugins, "rtc").bind((e => I.from(e.setup))))(e).fold(( () => (t.rtcInstance = GC(e),
        ...
        (e => {
            ...
            Wd(e) || (t.body.spellcheck = !1,
            kT.setAttrib(n, "spellcheck", "false")),
            e.quirks = _T(e),
            (e => {
      ...
      , UT = async e => {
        ...
        (e => {
            ...
            if (m(t)) {
                ...
                w(e.theme.init) && e.theme.init(e, Bw.urls[t] || e.documentBaseUrl.replace(/\/$/, ""))
            } else
                e.theme = {}
        }
        )(e),
        ...
        e.inline ? PT(e) : ( (e, t) => {
            ( (e, t) => {
                const n = e.translate("Rich Text Area")
                  ...
                  , r = ( (e, t, n, o) => {
                    const r = bn("iframe");
                    return o.each((e => Jt(r, "tabindex", e))),
                    Zt(r, n),
                    Zt(r, {
                        id: e + "_ifr",
                        frameBorder: "0",
                ...
                e.iframeHTML = (e => {
                    ...
                    Bl(e) !== e.documentBaseUrl && (t += '<base href="' + e.documentBaseURI.getURI() + '" />'),
                    t += '<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />';
                    const n = Pl(e)
                      , o = Dl(e)
                      , r = e.translate(jd(e));
                    return Ll(e) && (t += '<meta http-equiv="Content-Security-Policy" content="' + Ll(e) + '" />'),
      ...
      , $T = (e, t) => {
        ...
        ( (e, t) => {
            ...
            ge(Md(e), ( (t, o) => {
                n(o, t),
                e.options.set("plugins", Ld(e).concat(o))
            }
            )),
            V(Ld(e), (e => {
      ...
      , eO = (e, t) => {
        ...
        return /^ | $/.test(t) ? ( (e, t, n, o) => {
            ...
            return n = eh(r, Vi.fromRangeStart(t), o) ? n.replace(/^ /, "&nbsp;") : n.replace(/^&nbsp;/, " "),
            th(r, Vi.fromRangeEnd(t), o) ? n.replace(/(&nbsp;| )(<br( \/)>)?$/, "&nbsp;") : n.replace(/&nbsp;(<br( \/)?>)?$/, " ")
        }
      ...
      , sO = rO("font-size")
      , aO = k((e => e.replace(/[\'\"\\]/g, "").replace(/,\s+/g, ",")), rO("font-family"))
    ...
    )))(e).orThunk(T(iO, e)).map(yn).filter(Wt).bind(t))(e, S(I.some, t))
      , dO = (e, t) => {
        if (/^[0-9.]+$/.test(t)) {
      ...
      , mO = e => {
        ...
        (e => {
            e.editorCommands.addCommands({
                mceSelectNodeDepth: (t, n, o) => {
                    let r = 0;
                    e.dom.getParent(e.selection.getNode(), (t => !qo(t) || r++ !== o || (e.selection.select(t),
                    !1)), e.getBody())
                }
                ,
                mceSelectNode: (t, n, o) => {
        ...
        (e => {
            ...
            (e => {
                ...
                e.editorCommands.addQueryValueHandler("FontName", ( () => (e => lO(e, (t => aO(e.getBody(), t.dom))).getOr(""))(e))),
                e.editorCommands.addQueryValueHandler("FontSize", ( () => (e => lO(e, (t => sO(e.getBody(), t.dom))).getOr(""))(e))),
                e.editorCommands.addQueryValueHandler("LineHeight", ( () => (e => lO(e, (t => {
                    const n = yn(e.getBody())
                    ...
                    ( (e, t) => {
                        e.removed || (t ? Tg(e) : (e => {
                            ...
                            if (r && e.dom.isChildOf(r, n))
                                ...
                                Sg(e, o),
                                void Tg(e);
                            e.inline || (At.browser.isOpera() || Ng(n),
                            e.getWin().focus()),
                            (At.browser.isFirefox() || e.inline) && (Ng(n),
                            Sg(e, o)),
                            Tg(e)
                        }
                        )(e))
    ...
    const RO = (e, t) => {
        ...
        const n = fd(e);
        return n ? (e.eventRoot || (e.eventRoot = SO.select(n)[0]),
      ...
      , AO = (e, t, n) => {
        (e => !e.hidden && !yO(e))(e) ? e.dispatch(t, n) : yO(e) && ( (e, t) => {
            if ((e => "click" === e.type)(t) && !af.metaKeyPressed(t)) {
                ...
                (e => H(wO, e.type))(t) && e.dispatch(t.type, t)
        }
        )(e, n)
    }
      , TO = (e, t) => {
      ...
      , OO = {
        ...
        toggleNativeEvent(e, t) {
            const n = this;
            "focus" !== e && "blur" !== e && (n.removed || (t ? n.initialized ? TO(n, e) : n._pendingNativeEvents ? n._pendingNativeEvents.push(e) : n._pendingNativeEvents = [e] : n.initialized && n.delegates && (n.dom.unbind(RO(n, e), e, n.delegates[e]),
      ...
      , IO = (e, t, n, o) => {
        ...
        r.deactivate(),
        r.editorReadOnly !== s.editorReadOnly && ( (e, t) => {
            const n = yn(e.getBody());
            ( (e, t, n) => {
      ...
      , HO = e => {
        ...
        FO(UO(e.toLowerCase(), "+"), (e => {
            (e => e in jO)(e) ? t[e] = !0 : /^[0-9]{2,}$/.test(e) ? t.keyCode = parseInt(e, 10) : (t.charCode = e.charCodeAt(0),
    ...
    class YO {
        constructor(e, t, n) {
            ...
            this.options = ( (e, t) => {
                const n = {}
                  ...
                  , r = (e, t, n) => {
                    const r = LO(t, n);
                    return DO(r) ? (o[e] = r.value,
                    !0) : (console.warn(PO(`Invalid value passed for the ${e} option`, r)),
                    !1)
                }
                  , s = e => Ee(n, e);
                return {
            ...
            const l = ed(o);
            l && (Ha.ScriptLoader._setReferrerPolicy(l),
            ...
            this.setDirty(!1),
            this.documentBaseURI = new oC(Bl(o),{
        ...
        render() {
            (e => {
                ...
                Ka.setCode(td(e));
                const n = () => {
                    zT.unbind(window, "ready", n),
                    e.render()
                }
                ;
                if (!Ta.Event.domLoaded)
                    return void zT.bind(window, "ready", n);
                if (!e.getElement())
                    return;
                const o = yn(e.getElement())
                  , r = rn(o);
                e.on("remove", ( () => {
                    W(o.dom.attributes, (e => on(o, e.name))),
                    Zt(o, r)
                }
                )),
                ...
                kd(e) ? e.inline = !0 : (e.orgVisibility = e.getElement().style.visibility,
                e.getElement().style.visibility = "hidden");
                const s = e.getElement().form || zT.getParent(t, "form");
                s && (e.formElement = s,
                Sd(e) && !Zo(e.getElement()) && (zT.insertAfter(zT.create("input", {
                    type: "hidden",
                    name: t
                }), t),
                e.hasHiddenInput = !0),
                ...
                !Nd(e) || s.submit.nodeType || s.submit.length || s._mceOldSubmit || (s._mceOldSubmit = s.submit,
        ...
        show() {
            const e = this;
            e.hidden && (e.hidden = !1,
            e.inline ? e.getBody().contentEditable = "true" : (VO.show(e.getContainer()),
            VO.hide(e.id)),
            e.load(),
            e.dispatch("show"))
        }
        hide() {
            ...
            e === e.editorManager.focusedEditor && (e.editorManager.focusedEditor = null)) : (VO.hide(e.getContainer()),
        ...
        save(e={}) {
            ...
            Zo(n))
                ...
                o && KO(o.elements, (e => e.name !== t.id || (e.value = r,
                !1)))
            }
        ...
        getContainer() {
            const e = this;
            return e.container || (e.container = e.editorContainer || VO.get(e.id + "_parent")),
            e.container
        }
        ...
        getElement() {
            return this.targetElm || (this.targetElm = VO.get(this.id)),
            this.targetElm
        }
        getWin() {
            const e = this;
        ...
        setEditableRoot(e) {
            ( (e, t) => {
                e._editableRoot !== t && (e._editableRoot = t,
                e.readonly || (e.getBody().contentEditable = String(e.hasEditableRoot()),
                e.nodeChanged()),
                ( (e, t) => {
        ...
        remove() {
            (e => {
                if (!e.removed) {
                    ...
                    e.hasHiddenInput && C(null == r ? void 0 : r.nextSibling) && Cw.remove(r.nextSibling),
                    (e => {
                        e.dispatch("remove")
                    }
                    )(e),
    ...
    const eB = e => {
      ...
      , tB = e => {
        if (e !== JO) {
            const t = za.DOM;
            e ? (t.bind(window, "resize", eB),
            t.bind(window, "scroll", eB)) : (t.unbind(window, "resize", eB),
            t.unbind(window, "scroll", eB)),
            JO = e
        }
    }
      , nB = e => {
        const t = ZO;
        return ZO = Y(ZO, (t => e !== t)),
        rB.activeEditor === e && (rB.activeEditor = ZO.length > 0 ? ZO[0] : null),
      ...
      , rB = {
        ...
        init(e) {
            ...
            const s = () => {
                ...
                )((e => At.browser.isIE() || At.browser.isEdge() ? (Fw("TinyMCE does not support the browser you are using. For a list of supported browsers please see: https://www.tiny.cloud/docs/tinymce/6/support/#supportedwebbrowsers"),
                []) : oB ? (Fw("Failed to initialize the editor as the document is not in standards mode. TinyMCE requires standards mode."),
                []) : m(e.selector) ? GO.select(e.selector) : C(e.target) ? [e.target] : [])(e)),
                Pt.each(i, (e => {
                    var n;
                    (n = t.get(e.id)) && n.initialized && !(n.getContainer() || n.getBody()).parentNode && (nB(n),
                ...
                0 === i.length ? r([]) : XO(i, (s => {
                    ( (e, t) => e.inline && t.tagName.toLowerCase()in o)(e, s) ? Fw("Could not initialize inline editor on invalid inline target element", s) : ( (e, o, s) => {
                        ...
                        let t = e.id;
                        return t || (t = xe(e, "name").filter((e => !GO.get(e))).getOrThunk(GO.uniqueId),
                        e.setAttribute("id", t)),
                        t
                    }
                    )(s), e, s)
        ...
        remove(e) {
            ...
            if (e) {
                if (!m(e))
                    return n = e,
                    h(t.get(n.id)) ? null : (nB(n) && t.dispatch("RemoveEditor", {
                        editor: n
                    }),
                    0 === ZO.length && window.removeEventListener("beforeunload", QO),
                    n.remove(),
                    tB(ZO.length > 0),
                    n);
                XO(GO.select(e), (e => {
        ...
        _setBaseUrl(e) {
            this.baseURL = new oC(this.documentBaseURL).toAbsolute(e.replace(/\/+$/, "")),
            ...
            load: (n, o) => {
                    ...
                    return e[n];
                {
                    const a = new Promise(( (e, a) => {
                        ...
                        t[n] = i.resolve,
                        Ha.ScriptLoader.loadScript(o).then(( () => i.start(s)), ( () => i.reject(r)))
                    }
                    ));
                    return e[n] = a,
                    a

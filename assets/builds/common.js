...
function confirm_delete() {
    ...
    return "undefined" != typeof app && (t = app.lang.confirm_action_prompt),
    0 != confirm(t)
}
!function(t) {
    var e = !1;
    t.fn.appFormValidator = function(n) {
        var i = this
          , o = {
            email: {
                remote: t.fn.appFormValidator.internal_options.localization.email_exists
            }
        }
          , a = {
            rules: [],
            ...
            submitHandler: function(e) {
                var n = t(e);
                n.hasClass("disable-on-submit") && n.find('[type="submit"]').prop("disabled", !0);
                var i = n.find("[data-loading-text]");
                if (i.length > 0 && i.button("loading"),
                !r.onSubmit)
                    return !0;
                r.onSubmit(e)
            }
          ...
          , r = t.extend({}, a, n);
        return void 0 === r.messages.email && (r.messages.email = o.email),
        i.configureJqueryValidationDefaults = function() {
            ...
            t.validator.setDefaults({
                ...
                unhighlight: t.fn.appFormValidator.internal_options.error_unhighlight,
                ...
                errorPlacement: t.fn.appFormValidator.internal_options.error_placement
            }),
            i.addMethodFileSize(),
        ...
        i.addMethodFileSize = function() {
            t.validator.addMethod("filesize", (function(t, e, n) {
                return this.optional(e) || e.files[0].size <= n
            }
            ), t.fn.appFormValidator.internal_options.localization.file_exceeds_max_filesize)
        }
        ,
        i.addMethodExtension = function() {
            t.validator.addMethod("extension", (function(t, e, n) {
                return n = "string" == typeof n ? n.replace(/,/g, "|") : "png|jpe?g|gif",
                this.optional(e) || t.match(new RegExp("\\.(" + n + ")$","i"))
            }
            ), t.fn.appFormValidator.internal_options.localization.validation_extension_not_allowed)
        }
        ,
        i.validateCustomFields = function(e) {
            t.each(e.find(t.fn.appFormValidator.internal_options.required_custom_fields_selector), (function() {
                if (!t(this).parents("tr.main").length && !t(this).hasClass("do-not-validate") && (t(this).rules("add", {
                    required: !0
                }),
                t.fn.appFormValidator.internal_options.on_required_add_symbol)) {
                    var e = t(this).parents("." + t.fn.appFormValidator.internal_options.field_wrapper_class).find('[for="' + t(this).attr("name") + '"]');
                    e.length > 0 && 0 === e.find(".req").length && e.prepend('<small class="req text-danger">* </small>')
                }
            }
            ))
        }
        ...
        i.addRequiredFieldSymbol = function(e) {
            t.fn.appFormValidator.internal_options.on_required_add_symbol && t.each(r.rules, (function(t, n) {
                if ("required" == n && !jQuery.isPlainObject(n) || jQuery.isPlainObject(n) && n.hasOwnProperty("required")) {
                    var i = e.find('[for="' + t + '"]');
                    i.length > 0 && 0 === i.find(".req").length && i.prepend(' <small class="req text-danger">* </small>')
                }
            }
            ))
        }
...
$.fn.appFormValidator.internal_options = {
    ...
    error_placement: function(t, e) {
        e.parent(".input-group").length || e.parents(".chk").length ? e.parents(".chk").length ? t.insertAfter(e.parents(".chk")) : t.insertAfter(e.parent()) : e.is("select") && (e.hasClass("selectpicker") || e.hasClass("ajax-search")) ? t.insertAfter(e.parents("." + $.fn.appFormValidator.internal_options.field_wrapper_class + " *").last()) : t.insertAfter(e)
    },
    error_highlight: function(t) {
        var e = $(t).closest("." + $.fn.appFormValidator.internal_options.tab_panel_wrapper);
        e.length && !e.is(":visible") && $('a[href="#' + e.attr("id") + '"]').css("border-bottom", "1px solid red").css("color", "red").addClass($.fn.appFormValidator.internal_options.validated_tab_class),
        $(t).is("select") ? delay((function() {
            $(t).closest("." + $.fn.appFormValidator.internal_options.field_wrapper_class).addClass($.fn.appFormValidator.internal_options.field_wrapper_error_class)
        }
        ), 400) : $(t).closest("." + $.fn.appFormValidator.internal_options.field_wrapper_class).addClass($.fn.appFormValidator.internal_options.field_wrapper_error_class)
    },
    error_unhighlight: function(t) {
        var e = (t = $(t)).closest("." + $.fn.appFormValidator.internal_options.tab_panel_wrapper);
        t.closest("." + $.fn.appFormValidator.internal_options.field_wrapper_class).removeClass($.fn.appFormValidator.internal_options.field_wrapper_error_class),
        e.length && 0 === e.find("." + $.fn.appFormValidator.internal_options.field_wrapper_error_class).length && $('a[href="#' + e.attr("id") + '"]').removeAttr("style").removeClass($.fn.appFormValidator.internal_options.validated_tab_class)
    }
},
jQuery.extend({
    highlight: function(t, e, n, i) {
        if (3 === t.nodeType) {
            ...
            if (o) {
                ...
                var s = r.cloneNode(!0);
                return r.parentNode.tagName && "textarea" !== r.parentNode.tagName.toLowerCase() && (a.appendChild(s),
                r.parentNode.replaceChild(a, r)),
                1
            }
        } else if (1 === t.nodeType && t.childNodes && !/(script|style)/i.test(t.tagName) && (t.tagName !== n.toUpperCase() || t.className !== i))
...
function(t) {
    t.fn.googleDrivePicker = function(e) {
        var n, i;
        function o(e) {
            t(e).attr("data-picker-inited") || gapi.load("picker", (function() {
                t(e).attr("data-picker-inited", !0),
                e.disabled = !1,
                e.addEventListener("click", (function() {
                    var e;
                    i || (i = google.accounts.oauth2.initTokenClient({
                    ...
                    e = function() {
                        var e = (new google.picker.DocsView).setIncludeFolders(!0)
                          , i = (new google.picker.DocsUploadView).setIncludeFolders(!0);
                        r.mimeTypes && (e.setMimeTypes(r.mimeTypes),
                        i.setMimeTypes(r.mimeTypes)),
                        (new google.picker.PickerBuilder).addView(e).addView(i).setOAuthToken(n).setDeveloperKey(r.developerKey).setCallback(a).build().setVisible(!0),
                        setTimeout((function() {
        ...
        return this.each((function() {
            r.clientId ? (t(this).data("on-pick") && (r.onPick = t(this).data("on-pick")),
            o(t(this)[0]),
            t(this).css("opacity", 1)) : t(this).css("opacity", 0)
        }
        ))
    }
}(jQuery),
    ...
    e.prototype.refresh = function() {
        ...
        t = {
            ...
            for (var s in this.waypoints[a]) {
                var l, d, p, c, u = this.waypoints[a][s], f = u.options.offset, h = u.triggerPoint, m = 0, g = null == h;
                u.element !== u.element.window && (m = u.adapter.offset()[r.offsetProp]),
                ...
                c = !d && !p,
                !g && (d && p) ? (u.queueTrigger(r.backward),
                i[u.group.id] = u.group) : (!g && c || g && r.oldScroll >= u.triggerPoint) && (u.queueTrigger(r.forward),
...
function(t) {
    ...
    t.fn.isOnScreen = function(e, n) {
        ...
        return Math.min(1, (s.right - o.left) / r) * Math.min(1, (o.right - s.left) / r) >= e && l * d >= n
    }
    ,
        ...
        return this.each((function() {
            var e, n = t(this), i = {
                getArrowsTotalWidth: function() {
                    return n.find(".arrow-left").outerWidth() + n.find(".arrow-right").outerWidth()
                },
                adjustScroll: function() {
                    var o;
                    r = 0,
                    n.find(".nav-tabs-horizontal li:not(.nav-tabs-submenu-child, nav-tabs-submenu-parent)").each((function(i, a) {
                        r += t(a).outerWidth(),
                    ...
                    r > widthAvailale ? (n.find(".scroller").show(),
                    i.updateArrowStyle(s),
                    a = n.find(".nav-tabs-horizontal").outerWidth()) : n.find(".scroller").hide(),
                    o && setTimeout((function() {
                        s = o.position().left - i.getArrowsTotalWidth(),
                        n.find(".nav-tabs-horizontal").animate({
                            scrollLeft: s
                        }, 100)
                    }
                    ), 150)
                ...
                updateArrowStyle: function(t) {
                    new Waypoint({
                        ...
                        handler: function(t) {
                            delay((function() {
                                "right" == t && e.isOnScreen() ? n.find(".arrow-right").addClass("disabled") : n.find(".arrow-right").removeClass("disabled")
                            }
                            ), 200)
                        }
                    }),
                    t <= 0 ? (n.find(".arrow-left").addClass("disabled"),
                    setTimeout((function() {
                        n.find(".arrow-right").removeClass("disabled")
                    }
                    ), 100)) : n.find(".arrow-left").removeClass("disabled")
                },
                clearMenuItem: function(e) {
                    t('[data-sub-menu-id="' + e.attr("data-menu-id") + '"]').remove(),
                    e.removeAttr("data-menu-id")
                },
                genUniqueID: function() {
                    return Math.random().toString(36).substr(2, 9)
                }
            }, o = n.find("li.nav-tabs-submenu-parent > a"), a = n.find(".nav-tabs-horizontal").outerWidth(), r = 0, s = 0;
            return t(window).smartresize((function() {
                i.adjustScroll()
            }
            )),
            o.length > 0 && o.on("click", (function(e) {
                e.preventDefault();
                var n = t(this);
                if (n.attr("data-menu-id"))
                    return i.clearMenuItem(n),
                    !1;
                var o = i.genUniqueID();
                n.attr("data-menu-id", o);
                var a = n.parents("li.nav-tabs-submenu-parent").find(".tabs-submenu-wrapper").clone()
                  , r = n.offset();
                a.find("ul").css({
                ...
                a.find("ul li.active:eq(0) > a").css({
                    "border-top-left-radius": "0",
                    "border-top-right-radius": "0"
                }),
...
$(document).keyup((function(t) {
    27 == t.keyCode && $(".modal").is(":visible") && 1 === $(".modal:visible").length && $("body").find('.modal:visible [onclick^="close_modal_manually"]').eq(0).click()
}
)),
$((function() {
    setTimeout((function() {
        ...
        Array.prototype.forEach.call(t, (function(t) {
            t.addEventListener("mousedown", (function(t, e) {
                $(t.target).closest(".bar-wrapper").hasClass("noDrag") && event.stopPropagation()
            }
            ), !0)
        }
        ))
    ...
    $("body").on("click", ".add_more_attachments", (function() {
        ...
        if ($(this).data("max") && e >= $(this).data("max"))
            return !1;
        var n = $(".attachments").find(".attachment").eq(0).clone().appendTo(".attachments");
        n.find("input").removeAttr("aria-describedby aria-invalid"),
        n.find("input").attr("name", "attachments[" + t + "]").val(""),
        n.find($.fn.appFormValidator.internal_options.error_element + '[id*="error"]').remove(),
        n.find("." + $.fn.appFormValidator.internal_options.field_wrapper_class).removeClass($.fn.appFormValidator.internal_options.field_wrapper_error_class),
        n.find("i").removeClass("fa-plus").addClass("fa-minus"),
        n.find("button").removeClass("add_more_attachments").addClass("remove_attachment").removeClass("btn-success").removeClass("btn-default").addClass("btn-danger"),
        t++
    }
    )),
    ...
    $(document).on("hide.bs.dropdown", ".table-responsive", (function(t) {
        var e = $(t.target);
        e.hasClass("bootstrap-select") || e.data("dropdown-menu").css("display", "none")
    }
    )),
...
function buildUrl(t, e) {
    ...
    return n.length > 0 && (t = t + "?" + (n = n.substring(0, n.length - 1))),
    t
}
function is_ios() {
...
function _simple_editor_config() {
    return {
        ...
        plugins: ["quickbars", "table", "advlist", "codesample", "autosave", "lists", "link", "image", "media"],
...
function _add_print_window_default_styles(t) {
    ...
    t.document.write('.clearfix:after { clear: both;}.clearfix:before, .clearfix:after { display: table; content: " ";}body { font-family: Arial, Helvetica, sans-serif;color: #444; font-size:13px;}.bold { font-weight: bold !important;}'),
    t.document.write("</style>")
}
function nl2br(t, e) {
...
function tilt_direction(t) {
    setTimeout((function() {
        var e = t.position().left
          , n = function(n) {
            n.pageX >= e ? (t.addClass("right"),
            t.removeClass("left")) : (t.addClass("left"),
            t.removeClass("right")),
            e = n.pageX
        };
        $("html").on("mousemove", n),
        t.data("move_handler", n)
    }
    ), 1e3)
}
function close_modal_manually(t) {
    (t = 0 === $(t).length ? $("body").find(t) : t = $(t)).fadeOut("fast", (function() {
        t.remove(),
        $("body").find(".modal").is(":visible") || ($(".modal-backdrop").remove(),
...
function showPassword(t) {
    var e = $('input[name="' + t + '"]');
    "password" == $(e).attr("type") && "" !== $(e).val() ? $(e).queue((function() {
...
function appProgressBar() {
    ...
    t.length && t.each((function() {
        ...
        t.css("width", e + "%"),
        t.hasClass("no-percent-text") || t.text(e + "%")
    }
    ))
}
function appLightbox(t) {
    ...
    void 0 !== t && jQuery.extend(e, t),
    lightbox.option(e)
}
function DataTablesInlineLazyLoadImages(t, e, n) {
    var i = $("img.img-table-loading", t);
    return i.attr("src", i.data("orig")),
    i.prev("div").addClass("hide"),
    t
}
function _table_jump_to_page(t, e) {
    ...
    n.pages > 1) {
        for (var o = $("<select></select>", {
            ...
            a += "<option value='" + r + "'" + (n.page + 1 === r ? "selected" : "") + ">" + r + "</option>"
        }
        "" != a && o.append(a),
...
function alert_float(t, e, n) {
    ...
    (o = $("<div></div>", {
        id: i,
        class: "float-alert animated fadeInRight col-xs-10 col-sm-3 alert alert-" + t
...
function generatePassword(t) {
    for (var e = "abcdefghijklnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789", n = "", i = 0; i < 12; ++i)
        n += e.charAt(Math.floor(61 * Math.random()));
    $(t).parents().find("input.password").val(n)
}
function get_url_param(t) {
    var e = {};
    return window.location.href.replace(location.hash, "").replace(/[?&]+([^=&]+)=?([^&]*)?/gi, (function(t, n, i) {
        e[n] = void 0 !== i ? i : ""
    }
    )),
    t ? e[t] ? e[t] : null : e
    ...
    if (0 !== n.length) {
        var i, o, a, r = {
            ...
            fnDrawCallback: function(t) {
                ...
                0 == t.aoData.length || 0 == t.aiDisplay.length ? $(t.nTableWrapper).addClass("app_dt_empty") : $(t.nTableWrapper).removeClass("app_dt_empty"),
            ...
            initComplete: function(t, e) {
                ...
                if (i.length && i.attr("colspan", this.find("thead th").length),
                s.supportsLoading && this.parents(".table-loading").removeClass("table-loading"),
                s.supportsButtons) {
                    (o = n.find("thead th:last-child")).hasClass("options") && o.addClass("not-export");
                    var o = n.find("thead th:last-child");
                    "undefined" != typeof app && o.text().trim() == app.lang.options && o.addClass("not-export");
                    var a = n.find("thead th:first-child");
                    a.find('input[type="checkbox"]').length > 0 && a.addClass("not-export"),
                    "function" == typeof s.onInitComplete && s.onInitComplete(t, e, this)
                }
            }
        }, s = $.extend({}, r, e), l = [10, 25, 50, 100], d = [10, 25, 50, 100];
        s.pageLength = parseFloat(s.pageLength),
        -1 == $.inArray(s.pageLength, l) && (l.push(s.pageLength),
        d.push(s.pageLength)),
        l.sort((function(t, e) {
            return t - e
        }
        ...
        $.each(n, (function() {
            ...
            i && o && (s.order = [[i, o]]);
            var t = [];
            if ($(this).find("thead th").each((function(e) {
                var n = $(this)
                  , i = n.attr("data-orderable");
                void 0 === i || "false" !== i && "0" !== i && !1 !== i || t.push(e),
                (n.hasClass("no-sort") || n.hasClass("options")) && t.push(e)
            }
            )),
            t.length > 0 && (s.columnDefs || (s.columnDefs = []),
            s.columnDefs.push({
                orderable: !1,
                targets: t
            })),
...
function get_datatable_buttons(t) {
    ...
    var o = {
        body: function(t, e, n, i) {
            var o = $("<div></div>", t);
            o.append(t),
            o.find("[data-note-edit-textarea]").length > 0 && (o.find("[data-note-edit-textarea]").remove(),
            t = o.html().trim());
            var a = o.find(".text-has-action.is-date");
            a.length && (t = a.attr("data-title")),
            o.find(".row-options").length > 0 && (o.find(".row-options").remove(),
            t = o.html().trim()),
            o.find(".dropdown-toggle").length > 0 && (t = o.find(".dropdown-toggle").text().trim()),
            o.find(".table-export-exclude").length > 0 && (o.find(".table-export-exclude").remove(),
            t = o.html().trim());
    ...
    return $.each(r, (function() {
        var e = $(this);
        e.length && e.attr("data-table") && $(t).is(e.attr("data-table")) && a.push({
            text: e.text().trim(),
            className: "btn btn-sm btn-default-dt-options",
...
function _dt_maybe_export_only_selected_rows(t, e) {
    ...
    if (n && n.length > 0) {
        ...
        o ? e.find("tbody tr:eq(" + t + ') td:first input[type="checkbox"]:checked').length > 0 ? t : null : t
    }
    return t
}
...
function appDatepicker(t) {
    void 0 === app._date_picker_locale_configured && (jQuery.datetimepicker.setLocale(app.locale),
    ...
    var e = {
      ...
      , o = void 0 !== n.element_time ? n.element_time : $(n.date_time_picker_selector);
    0 === o.length && 0 === i.length || ($.each(i, (function() {
        var t = $(this)
          , e = {
            timepicker: !1,
            scrollInput: !1,
        ...
        o && (e.minDate = o),
        t.datetimepicker(e),
        t.parents(".form-group").find(".calendar-icon").on("click", (function() {
            t.focus(),
    ...
    $.each(o, (function() {
        ...
        24 == n.time_format ? e.format = n.date_format + " H:i" : (e.format = n.date_format + " g:i A",
        e.formatTime = "g:i A");
...
function appTagsInput(t) {
    ...
    t.length && t.tagit({
        ...
        afterTagAdded: function(t, e) {
            var n = app.available_tags.indexOf($.trim($(e.tag).find(".tagit-label").text()));
            if (n > -1) {
...
function _dropzone_defaults() {
    ...
    return "safari" === app.browser && t.indexOf(".jpg") > -1 && -1 === t.indexOf(".jpeg") && (t += ",.jpeg"),
    {
...
function escapeHtml(t, e=!0) {
    if (null == t)
        return "";
    "object" == typeof t && t.hasOwnProperty("value") && (t = t.value);
    let n = t.toString().replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#039;");
    return e || (n = n.replace(/&amp;(#\d+;|#[xX][\da-fA-F]+;|[a-zA-Z]+;)/g, "&$1")),
    n
}
function init_tinymce_inline_editor(t={}, e) {
    function n(e) {
        t.saveUsing && t.saveUsing(e)
    }
    e = e || "div.editable",
    tinymce.remove(e);
    var i = {
        ...
        plugins: ["quickbars", "advlist", "autolink", "lists", "link", "image", "visualblocks", "code", "pagebreak", "searchreplace", "media", "table"],
        ...
        setup: function(e) {
            ...
            e.on("MouseLeave blur", (function() {
                tinymce.activeEditor.isDirty() && n()
            }
            )),
            e.on("blur", (function() {
                $.Shortcuts.start()
    ...
    is_mobile() && window.addEventListener("beforeunload", (function(t) {
        tinymce.activeEditor.isDirty() && n()
    }
    )),
    tinymce.init(i)
...
function getTotalHorizontalMargin(t) {
    const e = window.getComputedStyle(t);
    return (parseFloat(e.marginLeft) || 0) + (parseFloat(e.marginRight) || 0)
}
